...
#line 145 "/home/maemo/python-qt4-4.7/sip/QtXml/qxml.sip"
#include <qxml.h>
...
static PyObject *meth_QXmlReader_setEntityResolver(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlReader, &sipCpp, sipType_QXmlEntityResolver, &a0))
        {
            if (!sipOrigSelf)
            {
...
static PyObject *meth_QXmlReader_setDTDHandler(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlReader, &sipCpp, sipType_QXmlDTDHandler, &a0))
        {
            if (!sipOrigSelf)
            {
...
static PyObject *meth_QXmlReader_setContentHandler(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlReader, &sipCpp, sipType_QXmlContentHandler, &a0))
        {
            if (!sipOrigSelf)
            {
...
static PyObject *meth_QXmlReader_setErrorHandler(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlReader, &sipCpp, sipType_QXmlErrorHandler, &a0))
        {
            if (!sipOrigSelf)
            {
...
static PyObject *meth_QXmlReader_setLexicalHandler(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlReader, &sipCpp, sipType_QXmlLexicalHandler, &a0))
        {
            if (!sipOrigSelf)
            {
...
static PyObject *meth_QXmlReader_setDeclHandler(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlReader, &sipCpp, sipType_QXmlDeclHandler, &a0))
        {
            if (!sipOrigSelf)
            {
