...
#line 40 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qsslsocket.sip"
...
static PyObject *meth_QSslSocket_readData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pn", &sipSelf, sipType_QSslSocket, &sipCpp, &a0))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;

#line 120 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qsslsocket.sip"
...
#line 2236 "sipQtNetworkQSslSocket.cpp"
...
static sipEncodedTypeDef supers_QSslSocket[] = {{81, 255, 1}};
...
static sipEnumMemberDef enummembers_QSslSocket[] = {
    {sipName_AutoVerifyPeer, QSslSocket::AutoVerifyPeer, 78},
    {sipName_QueryPeer, QSslSocket::QueryPeer, 78},
    {sipName_SslClientMode, QSslSocket::SslClientMode, 79},
    {sipName_SslServerMode, QSslSocket::SslServerMode, 79},
    {sipName_UnencryptedMode, QSslSocket::UnencryptedMode, 79},
    {sipName_VerifyNone, QSslSocket::VerifyNone, 78},
    {sipName_VerifyPeer, QSslSocket::VerifyPeer, 78},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QSslSocket[] = {
    {"encryptedBytesWritten(qint64)", "\1QSslSocket.encryptedBytesWritten(int)", 0},
    {"peerVerifyError(const QSslError&)", "\1QSslSocket.peerVerifyError(QSslError)", 0},
    {"modeChanged(QSslSocket::SslMode)", "\1QSslSocket.modeChanged(QSslSocket.SslMode)", 0},
    {"encrypted()", "\1QSslSocket.encrypted()", 0},
    {"sslErrors(const QList<QSslError>&)", "\1QSslSocket.sslErrors(list-of-QSslError)", &methods_QSslSocket[47]},
    {0, 0, 0}
};
