...
#line 40 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qsslcertificate.sip"
...
static sipEnumMemberDef enummembers_QSslError[] = {
    {sipName_AuthorityIssuerSerialNumberMismatch, QSslError::AuthorityIssuerSerialNumberMismatch, 75},
    {sipName_CertificateExpired, QSslError::CertificateExpired, 75},
    {sipName_CertificateNotYetValid, QSslError::CertificateNotYetValid, 75},
    {sipName_CertificateRejected, QSslError::CertificateRejected, 75},
    {sipName_CertificateRevoked, QSslError::CertificateRevoked, 75},
    {sipName_CertificateSignatureFailed, QSslError::CertificateSignatureFailed, 75},
    {sipName_CertificateUntrusted, QSslError::CertificateUntrusted, 75},
    {sipName_HostNameMismatch, QSslError::HostNameMismatch, 75},
    {sipName_InvalidCaCertificate, QSslError::InvalidCaCertificate, 75},
    {sipName_InvalidNotAfterField, QSslError::InvalidNotAfterField, 75},
    {sipName_InvalidNotBeforeField, QSslError::InvalidNotBeforeField, 75},
    {sipName_InvalidPurpose, QSslError::InvalidPurpose, 75},
    {sipName_NoError, QSslError::NoError, 75},
    {sipName_NoPeerCertificate, QSslError::NoPeerCertificate, 75},
    {sipName_NoSslSupport, QSslError::NoSslSupport, 75},
    {sipName_PathLengthExceeded, QSslError::PathLengthExceeded, 75},
    {sipName_SelfSignedCertificate, QSslError::SelfSignedCertificate, 75},
    {sipName_SelfSignedCertificateInChain, QSslError::SelfSignedCertificateInChain, 75},
    {sipName_SubjectIssuerMismatch, QSslError::SubjectIssuerMismatch, 75},
    {sipName_UnableToDecodeIssuerPublicKey, QSslError::UnableToDecodeIssuerPublicKey, 75},
    {sipName_UnableToDecryptCertificateSignature, QSslError::UnableToDecryptCertificateSignature, 75},
    {sipName_UnableToGetIssuerCertificate, QSslError::UnableToGetIssuerCertificate, 75},
    {sipName_UnableToGetLocalIssuerCertificate, QSslError::UnableToGetLocalIssuerCertificate, 75},
    {sipName_UnableToVerifyFirstCertificate, QSslError::UnableToVerifyFirstCertificate, 75},
    {sipName_UnspecifiedError, QSslError::UnspecifiedError, 75},
};
