...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qftp.sip"
#include <qftp.h>
...
#line 112 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qftp.sip"
...
static sipEncodedTypeDef supers_QFtp[] = {{129, 0, 1}};
...
static PyMethodDef methods_QFtp[] = {
    ...
    {SIP_MLNAME_CAST(sipName_read), (PyCFunction)meth_QFtp_read, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QFtp_read)},
...
static const pyqt4QtSignal pyqt4_signals_QFtp[] = {
    {"done(bool)", "\1QFtp.done(bool)", 0},
    {"commandFinished(int,bool)", "\1QFtp.commandFinished(int, bool)", 0},
    {"commandStarted(int)", "\1QFtp.commandStarted(int)", 0},
    {"rawCommandReply(int,const QString&)", "\1QFtp.rawCommandReply(int, QString)", 0},
    {"dataTransferProgress(qint64,qint64)", "\1QFtp.dataTransferProgress(int, int)", 0},
    {"readyRead()", "\1QFtp.readyRead()", 0},
    {"listInfo(const QUrlInfo&)", "\1QFtp.listInfo(QUrlInfo)", 0},
    {"stateChanged(int)", "\1QFtp.stateChanged(int)", 0},
    {0, 0, 0}
};
