...
static sipEnumMemberDef enummembers_QNetworkProxy[] = {
    {sipName_CachingCapability, QNetworkProxy::CachingCapability, 52},
    {sipName_DefaultProxy, QNetworkProxy::DefaultProxy, 53},
    {sipName_FtpCachingProxy, QNetworkProxy::FtpCachingProxy, 53},
    {sipName_HostNameLookupCapability, QNetworkProxy::HostNameLookupCapability, 52},
    {sipName_HttpCachingProxy, QNetworkProxy::HttpCachingProxy, 53},
    {sipName_HttpProxy, QNetworkProxy::HttpProxy, 53},
    {sipName_ListeningCapability, QNetworkProxy::ListeningCapability, 52},
    {sipName_NoProxy, QNetworkProxy::NoProxy, 53},
    {sipName_Socks5Proxy, QNetworkProxy::Socks5Proxy, 53},
    {sipName_TunnelingCapability, QNetworkProxy::TunnelingCapability, 52},
    {sipName_UdpTunnelingCapability, QNetworkProxy::UdpTunnelingCapability, 52},
};
