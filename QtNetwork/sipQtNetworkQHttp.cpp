...
#line 122 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qhttp.sip"
#include <qhttp.h>
...
static PyObject *meth_QHttp_setSocket(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QHttp, &sipCpp, sipType_QTcpSocket, &a0))
        {
            int sipRes;
...
#line 191 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qhttp.sip"
...
#line 827 "sipQtNetworkQHttp.cpp"
...
static sipEncodedTypeDef supers_QHttp[] = {{129, 0, 1}};
...
static PyMethodDef methods_QHttp[] = {
    ...
    {SIP_MLNAME_CAST(sipName_read), (PyCFunction)meth_QHttp_read, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QHttp_read)},
...
static const pyqt4QtSignal pyqt4_signals_QHttp[] = {
    {"sslErrors(const QList<QSslError>&)", "\1QHttp.sslErrors(list-of-QSslError)", 0},
    {"authenticationRequired(const QString&,quint16,QAuthenticator *)", "\1QHttp.authenticationRequired(QString, int, QAuthenticator)", 0},
    {"proxyAuthenticationRequired(const QNetworkProxy&,QAuthenticator *)", "\1QHttp.proxyAuthenticationRequired(QNetworkProxy, QAuthenticator)", 0},
    {"done(bool)", "\1QHttp.done(bool)", 0},
    {"requestFinished(int,bool)", "\1QHttp.requestFinished(int, bool)", 0},
    {"requestStarted(int)", "\1QHttp.requestStarted(int)", 0},
    {"dataReadProgress(int,int)", "\1QHttp.dataReadProgress(int, int)", 0},
    {"dataSendProgress(int,int)", "\1QHttp.dataSendProgress(int, int)", 0},
    {"readyRead(const QHttpResponseHeader&)", "\1QHttp.readyRead(QHttpResponseHeader)", 0},
    {"responseHeaderReceived(const QHttpResponseHeader&)", "\1QHttp.responseHeaderReceived(QHttpResponseHeader)", 0},
    {"stateChanged(int)", "\1QHttp.stateChanged(int)", 0},
    {0, 0, 0}
};
