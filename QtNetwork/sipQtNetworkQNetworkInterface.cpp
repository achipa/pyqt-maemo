...
static sipEnumMemberDef enummembers_QNetworkInterface[] = {
    {sipName_CanBroadcast, QNetworkInterface::CanBroadcast, 48},
    {sipName_CanMulticast, QNetworkInterface::CanMulticast, 48},
    {sipName_IsLoopBack, QNetworkInterface::IsLoopBack, 48},
    {sipName_IsPointToPoint, QNetworkInterface::IsPointToPoint, 48},
    {sipName_IsRunning, QNetworkInterface::IsRunning, 48},
    {sipName_IsUp, QNetworkInterface::IsUp, 48},
};
