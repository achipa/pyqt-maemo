...
static PyObject *meth_QAbstractSocket_readData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pn", &sipSelf, sipType_QAbstractSocket, &sipCpp, &a0))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;

#line 229 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qabstractsocket.sip"
...
#line 1615 "sipQtNetworkQAbstractSocket.cpp"
...
#line 267 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qabstractsocket.sip"
        // Return the data read or None if there was an error.
        if (a0 < 0)
        {
            PyErr_SetString(PyExc_ValueError, "maximum length of data to be read cannot be negative");
...
#line 1688 "sipQtNetworkQAbstractSocket.cpp"
...
static sipEncodedTypeDef supers_QAbstractSocket[] = {{77, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QAbstractSocket[] = {
    {"proxyAuthenticationRequired(const QNetworkProxy&,QAuthenticator *)", "\1QAbstractSocket.proxyAuthenticationRequired(QNetworkProxy, QAuthenticator)", 0},
    {"stateChanged(QAbstractSocket::SocketState)", "\1QAbstractSocket.stateChanged(QAbstractSocket.SocketState)", 0},
    {"disconnected()", "\1QAbstractSocket.disconnected()", 0},
    {"connected()", "\1QAbstractSocket.connected()", 0},
    {"hostFound()", "\1QAbstractSocket.hostFound()", 0},
    {"error(QAbstractSocket::SocketError)", "\1QAbstractSocket.error(QAbstractSocket.SocketError)", &methods_QAbstractSocket[10]},
    {0, 0, 0}
};
