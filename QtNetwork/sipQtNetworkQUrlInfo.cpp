...
static sipEnumMemberDef enummembers_QUrlInfo[] = {
    {sipName_ExeGroup, QUrlInfo::ExeGroup, 86},
    {sipName_ExeOther, QUrlInfo::ExeOther, 86},
    {sipName_ExeOwner, QUrlInfo::ExeOwner, 86},
    {sipName_ReadGroup, QUrlInfo::ReadGroup, 86},
    {sipName_ReadOther, QUrlInfo::ReadOther, 86},
    {sipName_ReadOwner, QUrlInfo::ReadOwner, 86},
    {sipName_WriteGroup, QUrlInfo::WriteGroup, 86},
    {sipName_WriteOther, QUrlInfo::WriteOther, 86},
    {sipName_WriteOwner, QUrlInfo::WriteOwner, 86},
};
