...
static PyObject *meth_QLocalSocket_readData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pn", &sipSelf, sipType_QLocalSocket, &sipCpp, &a0))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;

#line 128 "/home/maemo/python-qt4-4.7/sip/QtNetwork/qlocalsocket.sip"
...
#line 1297 "sipQtNetworkQLocalSocket.cpp"
...
static sipEncodedTypeDef supers_QLocalSocket[] = {{77, 0, 1}};
...
static sipEnumMemberDef enummembers_QLocalSocket[] = {
    {sipName_ClosingState, QLocalSocket::ClosingState, 37},
    {sipName_ConnectedState, QLocalSocket::ConnectedState, 37},
    {sipName_ConnectingState, QLocalSocket::ConnectingState, 37},
    {sipName_ConnectionError, QLocalSocket::ConnectionError, 36},
    {sipName_ConnectionRefusedError, QLocalSocket::ConnectionRefusedError, 36},
    {sipName_DatagramTooLargeError, QLocalSocket::DatagramTooLargeError, 36},
    {sipName_PeerClosedError, QLocalSocket::PeerClosedError, 36},
    {sipName_ServerNotFoundError, QLocalSocket::ServerNotFoundError, 36},
    {sipName_SocketAccessError, QLocalSocket::SocketAccessError, 36},
    {sipName_SocketResourceError, QLocalSocket::SocketResourceError, 36},
    {sipName_SocketTimeoutError, QLocalSocket::SocketTimeoutError, 36},
    {sipName_UnconnectedState, QLocalSocket::UnconnectedState, 37},
    {sipName_UnknownSocketError, QLocalSocket::UnknownSocketError, 36},
    {sipName_UnsupportedSocketOperationError, QLocalSocket::UnsupportedSocketOperationError, 36},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QLocalSocket[] = {
    {"stateChanged(QLocalSocket::LocalSocketState)", "\1QLocalSocket.stateChanged(QLocalSocket.LocalSocketState)", 0},
    {"disconnected()", "\1QLocalSocket.disconnected()", 0},
    {"connected()", "\1QLocalSocket.connected()", 0},
    {"error(QLocalSocket::LocalSocketError)", "\1QLocalSocket.error(QLocalSocket.LocalSocketError)", &methods_QLocalSocket[7]},
    {0, 0, 0}
};
