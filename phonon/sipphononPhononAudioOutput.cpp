...
PyDoc_STRVAR(doc_Phonon_AudioOutput_name, "Phonon.AudioOutput.name() -> QString");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_volume, "Phonon.AudioOutput.volume() -> float");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_volumeDecibel, "Phonon.AudioOutput.volumeDecibel() -> float");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_category, "Phonon.AudioOutput.category() -> Phonon.Category");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_outputDevice, "Phonon.AudioOutput.outputDevice() -> Phonon.AudioOutputDevice");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_isMuted, "Phonon.AudioOutput.isMuted() -> bool");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_setName, "Phonon.AudioOutput.setName(QString)");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_setVolume, "Phonon.AudioOutput.setVolume(float)");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_setVolumeDecibel, "Phonon.AudioOutput.setVolumeDecibel(float)");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_setOutputDevice, "Phonon.AudioOutput.setOutputDevice(Phonon.AudioOutputDevice) -> bool");
...
PyDoc_STRVAR(doc_Phonon_AudioOutput_setMuted, "Phonon.AudioOutput.setMuted(bool)");
...
extern "C" {static void *init_Phonon_AudioOutput(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_Phonon_AudioOutput(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static const pyqt4QtSignal pyqt4_signals_Phonon_AudioOutput[] = {
    {"outputDeviceChanged(const Phonon::AudioOutputDevice&)", "\1Phonon.AudioOutput.outputDeviceChanged(Phonon.AudioOutputDevice)", 0},
    {"mutedChanged(bool)", "\1Phonon.AudioOutput.mutedChanged(bool)", 0},
    {"volumeChanged(qreal)", "\1Phonon.AudioOutput.volumeChanged(float)", 0},
    {0, 0, 0}
};

PyDoc_STRVAR(doc_Phonon_AudioOutput, "\1Phonon.AudioOutput(Phonon.Category, QObject parent=None)\n"
    "Phonon.AudioOutput(QObject parent=None)");
