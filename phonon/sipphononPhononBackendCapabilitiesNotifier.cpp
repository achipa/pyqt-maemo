...
static sipEncodedTypeDef supers_Phonon_BackendCapabilities_Notifier[] = {{129, 0, 1}};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_Phonon_BackendCapabilities_Notifier[] = {
    {"availableAudioCaptureDevicesChanged()", "\1Phonon.BackendCapabilities.Notifier.availableAudioCaptureDevicesChanged()", 0},
    {"availableAudioOutputDevicesChanged()", "\1Phonon.BackendCapabilities.Notifier.availableAudioOutputDevicesChanged()", 0},
    {"capabilitiesChanged()", "\1Phonon.BackendCapabilities.Notifier.capabilitiesChanged()", 0},
    {0, 0, 0}
};
