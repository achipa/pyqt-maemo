...
{
    return (sip_QtMultimedia_qt_metacast && sip_QtMultimedia_qt_metacast(sipPySelf,sipType_QAudioOutput,_clname)) ? this : QAudioOutput::qt_metacast(_clname);
}
...
static void release_QAudioOutput(void *sipCppV,int sipState)
{
    Py_BEGIN_ALLOW_THREADS

    if (sipState & SIP_DERIVED_CLASS)
        delete reinterpret_cast<sipQAudioOutput *>(sipCppV);
    else
        delete reinterpret_cast<QAudioOutput *>(sipCppV);
...
static void dealloc_QAudioOutput(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQAudioOutput *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QAudioOutput(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QAudioOutput(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_QAudioOutput(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static sipEncodedTypeDef supers_QAudioOutput[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QAudioOutput[] = {
    {"notify()", "\1QAudioOutput.notify()", 0},
    {"stateChanged(QAudio::State)", "\1QAudioOutput.stateChanged(QAudio.State)", 0},
    {0, 0, 0}
};
