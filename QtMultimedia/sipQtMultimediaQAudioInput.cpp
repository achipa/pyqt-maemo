...
{
    return (sip_QtMultimedia_qt_metacast && sip_QtMultimedia_qt_metacast(sipPySelf,sipType_QAudioInput,_clname)) ? this : QAudioInput::qt_metacast(_clname);
}
...
static void release_QAudioInput(void *sipCppV,int sipState)
{
    Py_BEGIN_ALLOW_THREADS

    if (sipState & SIP_DERIVED_CLASS)
        delete reinterpret_cast<sipQAudioInput *>(sipCppV);
    else
        delete reinterpret_cast<QAudioInput *>(sipCppV);
...
static void dealloc_QAudioInput(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQAudioInput *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QAudioInput(sipSelf->u.cppPtr,sipSelf->flags);
    }
}


extern "C" {static void *init_QAudioInput(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_QAudioInput(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static sipEncodedTypeDef supers_QAudioInput[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QAudioInput[] = {
    {"notify()", "\1QAudioInput.notify()", 0},
    {"stateChanged(QAudio::State)", "\1QAudioInput.stateChanged(QAudio.State)", 0},
    {0, 0, 0}
};
