...
_pkg_config = {
    ...
    'pyqt_config_args':  '-w --confirm-license --no-designer-plugin',
    'pyqt_mod_dir':      '/usr/lib/python2.5/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtMaemo5 QtMultimedia QtNetwork QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtWebKit QtXml QtXmlPatterns phonon',
    ...
    'pyqt_version_str':  'snapshot-4.7.4-4e4296742920',
