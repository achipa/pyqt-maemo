...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qgraphicswebview.sip"
...
#include <qwebpage.h>
#line 113 "sipQtWebKitQGraphicsWebView.cpp"
#line 37 "/home/maemo/python-qt4-4.7/sip/QtGui/qaction.sip"
#include <qaction.h>
#line 116 "sipQtWebKitQGraphicsWebView.cpp"
...
#include <qpainterpath.h>
#line 160 "sipQtWebKitQGraphicsWebView.cpp"
#line 125 "/home/maemo/python-qt4-4.7/sip/QtCore/qlist.sip"
#include <qlist.h>
#line 163 "sipQtWebKitQGraphicsWebView.cpp"
...
void sipQGraphicsWebView::getContentsMargins(qreal *a0,qreal *a1,qreal *a2,qreal *a3) const
{
    ...
    typedef void (*sipVH_QtGui_197)(sip_gilstate_t,PyObject *,double *,double *,double *,double *);
...
static PyObject *meth_QGraphicsWebView_setPage(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QGraphicsWebView, &sipCpp, sipType_QWebPage, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setPage(a0);
            Py_END_ALLOW_THREADS
...
static void dealloc_QGraphicsWebView(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQGraphicsWebView *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QGraphicsWebView(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QGraphicsWebView[] = {{215, 2, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QGraphicsWebView[] = {
    {"linkClicked(const QUrl&)", "\1QGraphicsWebView.linkClicked(QUrl)", 0},
    {"statusBarMessage(const QString&)", "\1QGraphicsWebView.statusBarMessage(QString)", 0},
    {"iconChanged()", "\1QGraphicsWebView.iconChanged()", 0},
    {"titleChanged(const QString&)", "\1QGraphicsWebView.titleChanged(QString)", 0},
    {"urlChanged(const QUrl&)", "\1QGraphicsWebView.urlChanged(QUrl)", 0},
    {"loadProgress(int)", "\1QGraphicsWebView.loadProgress(int)", 0},
    {"loadFinished(bool)", "\1QGraphicsWebView.loadFinished(bool)", 0},
    {"loadStarted()", "\1QGraphicsWebView.loadStarted()", 0},
    {0, 0, 0}
};
