...
static sipEnumMemberDef enummembers_QWebSettings[] = {
    {sipName_AutoLoadImages, QWebSettings::AutoLoadImages, 42},
    {sipName_CursiveFont, QWebSettings::CursiveFont, 40},
    {sipName_DefaultFixedFontSize, QWebSettings::DefaultFixedFontSize, 41},
    {sipName_DefaultFontSize, QWebSettings::DefaultFontSize, 41},
    {sipName_DefaultFrameIconGraphic, QWebSettings::DefaultFrameIconGraphic, 43},
    {sipName_DeveloperExtrasEnabled, QWebSettings::DeveloperExtrasEnabled, 42},
    {sipName_DnsPrefetchEnabled, QWebSettings::DnsPrefetchEnabled, 42},
    {sipName_FantasyFont, QWebSettings::FantasyFont, 40},
    {sipName_FixedFont, QWebSettings::FixedFont, 40},
    {sipName_JavaEnabled, QWebSettings::JavaEnabled, 42},
    {sipName_JavascriptCanAccessClipboard, QWebSettings::JavascriptCanAccessClipboard, 42},
    {sipName_JavascriptCanOpenWindows, QWebSettings::JavascriptCanOpenWindows, 42},
    {sipName_JavascriptEnabled, QWebSettings::JavascriptEnabled, 42},
    {sipName_LinksIncludedInFocusChain, QWebSettings::LinksIncludedInFocusChain, 42},
    {sipName_LocalContentCanAccessRemoteUrls, QWebSettings::LocalContentCanAccessRemoteUrls, 42},
    {sipName_LocalStorageDatabaseEnabled, QWebSettings::LocalStorageDatabaseEnabled, 42},
    {sipName_LocalStorageEnabled, QWebSettings::LocalStorageEnabled, 42},
    {sipName_MinimumFontSize, QWebSettings::MinimumFontSize, 41},
    {sipName_MinimumLogicalFontSize, QWebSettings::MinimumLogicalFontSize, 41},
    {sipName_MissingImageGraphic, QWebSettings::MissingImageGraphic, 43},
    {sipName_MissingPluginGraphic, QWebSettings::MissingPluginGraphic, 43},
    {sipName_OfflineStorageDatabaseEnabled, QWebSettings::OfflineStorageDatabaseEnabled, 42},
    {sipName_OfflineWebApplicationCacheEnabled, QWebSettings::OfflineWebApplicationCacheEnabled, 42},
    {sipName_PluginsEnabled, QWebSettings::PluginsEnabled, 42},
    {sipName_PrintElementBackgrounds, QWebSettings::PrintElementBackgrounds, 42},
    {sipName_PrivateBrowsingEnabled, QWebSettings::PrivateBrowsingEnabled, 42},
    {sipName_SansSerifFont, QWebSettings::SansSerifFont, 40},
    {sipName_SerifFont, QWebSettings::SerifFont, 40},
    {sipName_StandardFont, QWebSettings::StandardFont, 40},
    {sipName_TextAreaSizeGripCornerGraphic, QWebSettings::TextAreaSizeGripCornerGraphic, 43},
    {sipName_ZoomTextOnly, QWebSettings::ZoomTextOnly, 42},
};
