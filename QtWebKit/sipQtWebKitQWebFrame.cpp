...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebsecurityorigin.sip"
...
static sipEncodedTypeDef supers_QWebFrame[] = {{129, 0, 1}};
...
static PyMethodDef methods_QWebFrame[] = {
    ...
    {SIP_MLNAME_CAST(sipName_print), (PyCFunction)meth_QWebFrame_print, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QWebFrame_print)},
...
static const pyqt4QtSignal pyqt4_signals_QWebFrame[] = {
    {"loadFinished(bool)", "\1QWebFrame.loadFinished(bool)", 0},
    {"loadStarted()", "\1QWebFrame.loadStarted()", 0},
    {"contentsSizeChanged(const QSize&)", "\1QWebFrame.contentsSizeChanged(QSize)", 0},
    {"iconChanged()", "\1QWebFrame.iconChanged()", 0},
    {"initialLayoutCompleted()", "\1QWebFrame.initialLayoutCompleted()", 0},
    {"urlChanged(const QUrl&)", "\1QWebFrame.urlChanged(QUrl)", 0},
    {"titleChanged(const QString&)", "\1QWebFrame.titleChanged(QString)", 0},
    {"javaScriptWindowObjectCleared()", "\1QWebFrame.javaScriptWindowObjectCleared()", 0},
    {0, 0, 0}
};
