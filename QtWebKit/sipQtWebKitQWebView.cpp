...
#include <qpainter.h>
#line 46 "sipQtWebKitQWebView.cpp"
#line 41 "/home/maemo/python-qt4-4.7/sip/QtGui/qpainter.sip"
#include <qpainter.h>
#line 49 "sipQtWebKitQWebView.cpp"
...
#include <qevent.h>
#line 87 "sipQtWebKitQWebView.cpp"
#line 428 "/home/maemo/python-qt4-4.7/sip/QtGui/qevent.sip"
#include <qevent.h>
#line 90 "sipQtWebKitQWebView.cpp"
...
static PyObject *meth_QWebView_setPage(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QWebView, &sipCpp, sipType_QWebPage, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setPage(a0);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QWebView[] = {{741, 2, 1}};
...
static PyMethodDef methods_QWebView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_print), (PyCFunction)meth_QWebView_print, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QWebView_print)},
...
static const pyqt4QtSignal pyqt4_signals_QWebView[] = {
    {"urlChanged(const QUrl&)", "\1QWebView.urlChanged(QUrl)", 0},
    {"iconChanged()", "\1QWebView.iconChanged()", 0},
    {"selectionChanged()", "\1QWebView.selectionChanged()", 0},
    {"linkClicked(const QUrl&)", "\1QWebView.linkClicked(QUrl)", 0},
    {"statusBarMessage(const QString&)", "\1QWebView.statusBarMessage(QString)", 0},
    {"titleChanged(const QString&)", "\1QWebView.titleChanged(QString)", 0},
    {"loadFinished(bool)", "\1QWebView.loadFinished(bool)", 0},
    {"loadProgress(int)", "\1QWebView.loadProgress(int)", 0},
    {"loadStarted()", "\1QWebView.loadStarted()", 0},
    {0, 0, 0}
};
