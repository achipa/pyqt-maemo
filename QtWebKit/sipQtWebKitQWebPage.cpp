...
#line 80 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebframe.sip"
#include <qwebframe.h>
...
#line 81 "sipQtWebKitQWebPage.cpp"
#line 41 "/home/maemo/python-qt4-4.7/sip/QtCore/qrect.sip"
#include <qrect.h>
#line 84 "sipQtWebKitQWebPage.cpp"
#line 45 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpage.sip"
#include <qwebpage.h>
#line 235 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpage.sip"
#include <qwebpage.h>
...
#line 314 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpage.sip"
#include <qwebpage.h>
#line 95 "sipQtWebKitQWebPage.cpp"
#line 45 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpage.sip"
#include <qwebpage.h>
#line 235 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpage.sip"
#include <qwebpage.h>
...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpluginfactory.sip"
#include <qwebpluginfactory.h>
#line 47 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpluginfactory.sip"
#include <qwebpluginfactory.h>
#line 65 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpluginfactory.sip"
#include <qwebpluginfactory.h>
#line 87 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpluginfactory.sip"
#include <qwebpluginfactory.h>
#line 95 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebpluginfactory.sip"
#include <qwebpluginfactory.h>
...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtWebKit/qwebsettings.sip"
...
static PyObject *meth_QWebPage_setView(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QWebPage, &sipCpp, sipType_QWidget, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setView(a0);
            Py_END_ALLOW_THREADS
...
static PyObject *meth_QWebPage_setNetworkAccessManager(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QWebPage, &sipCpp, sipType_QNetworkAccessManager, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static PyObject *meth_QWebPage_javaScriptPrompt(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    if (sipIsAPIEnabled(sipName_QString, 2, 0))
    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pJ8J1J1", &sipSelf, sipType_QWebPage, &sipCpp, sipType_QWebFrame, &a0, sipType_QString,&a1, &a1State, sipType_QString,&a2, &a2State))
        {
            bool sipRes;
            a3 = new QString();
    ...
    if (sipIsAPIEnabled(sipName_QString, 0, 2))
    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, NULL, NULL, "pJ8J1J1J8", &sipSelf, sipType_QWebPage, &sipCpp, sipType_QWebFrame, &a0, sipType_QString,&a1, &a1State, sipType_QString,&a2, &a2State, sipType_QString,&a3))
        {
            bool sipRes;
...
static sipEncodedTypeDef supers_QWebPage[] = {{129, 0, 1}};
...
static sipEnumMemberDef enummembers_QWebPage[] = {
    {sipName_AlignCenter, QWebPage::AlignCenter, 30},
    {sipName_AlignJustified, QWebPage::AlignJustified, 30},
    {sipName_AlignLeft, QWebPage::AlignLeft, 30},
    {sipName_AlignRight, QWebPage::AlignRight, 30},
    {sipName_Back, QWebPage::Back, 30},
    {sipName_ChooseMultipleFilesExtension, QWebPage::ChooseMultipleFilesExtension, 23},
    {sipName_Copy, QWebPage::Copy, 30},
    {sipName_CopyImageToClipboard, QWebPage::CopyImageToClipboard, 30},
    {sipName_CopyLinkToClipboard, QWebPage::CopyLinkToClipboard, 30},
    {sipName_Cut, QWebPage::Cut, 30},
    {sipName_DelegateAllLinks, QWebPage::DelegateAllLinks, 28},
    {sipName_DelegateExternalLinks, QWebPage::DelegateExternalLinks, 28},
    {sipName_DeleteEndOfWord, QWebPage::DeleteEndOfWord, 30},
    {sipName_DeleteStartOfWord, QWebPage::DeleteStartOfWord, 30},
    {sipName_DontDelegateLinks, QWebPage::DontDelegateLinks, 28},
    {sipName_DownloadImageToDisk, QWebPage::DownloadImageToDisk, 30},
    {sipName_DownloadLinkToDisk, QWebPage::DownloadLinkToDisk, 30},
    {sipName_FindBackward, QWebPage::FindBackward, 26},
    {sipName_FindCaseSensitively, QWebPage::FindCaseSensitively, 26},
    {sipName_FindWrapsAroundDocument, QWebPage::FindWrapsAroundDocument, 26},
    {sipName_Forward, QWebPage::Forward, 30},
    {sipName_HighlightAllOccurrences, QWebPage::HighlightAllOccurrences, 26},
    {sipName_Indent, QWebPage::Indent, 30},
    {sipName_InsertLineSeparator, QWebPage::InsertLineSeparator, 30},
    {sipName_InsertOrderedList, QWebPage::InsertOrderedList, 30},
    {sipName_InsertParagraphSeparator, QWebPage::InsertParagraphSeparator, 30},
    {sipName_InsertUnorderedList, QWebPage::InsertUnorderedList, 30},
    {sipName_InspectElement, QWebPage::InspectElement, 30},
    {sipName_MoveToEndOfBlock, QWebPage::MoveToEndOfBlock, 30},
    {sipName_MoveToEndOfDocument, QWebPage::MoveToEndOfDocument, 30},
    {sipName_MoveToEndOfLine, QWebPage::MoveToEndOfLine, 30},
    {sipName_MoveToNextChar, QWebPage::MoveToNextChar, 30},
    {sipName_MoveToNextLine, QWebPage::MoveToNextLine, 30},
    {sipName_MoveToNextWord, QWebPage::MoveToNextWord, 30},
    {sipName_MoveToPreviousChar, QWebPage::MoveToPreviousChar, 30},
    {sipName_MoveToPreviousLine, QWebPage::MoveToPreviousLine, 30},
    {sipName_MoveToPreviousWord, QWebPage::MoveToPreviousWord, 30},
    {sipName_MoveToStartOfBlock, QWebPage::MoveToStartOfBlock, 30},
    {sipName_MoveToStartOfDocument, QWebPage::MoveToStartOfDocument, 30},
    {sipName_MoveToStartOfLine, QWebPage::MoveToStartOfLine, 30},
    {sipName_NavigationTypeBackOrForward, QWebPage::NavigationTypeBackOrForward, 29},
    {sipName_NavigationTypeFormResubmitted, QWebPage::NavigationTypeFormResubmitted, 29},
    {sipName_NavigationTypeFormSubmitted, QWebPage::NavigationTypeFormSubmitted, 29},
    {sipName_NavigationTypeLinkClicked, QWebPage::NavigationTypeLinkClicked, 29},
    {sipName_NavigationTypeOther, QWebPage::NavigationTypeOther, 29},
    {sipName_NavigationTypeReload, QWebPage::NavigationTypeReload, 29},
    {sipName_NoWebAction, QWebPage::NoWebAction, 30},
    {sipName_OpenFrameInNewWindow, QWebPage::OpenFrameInNewWindow, 30},
    {sipName_OpenImageInNewWindow, QWebPage::OpenImageInNewWindow, 30},
    {sipName_OpenLink, QWebPage::OpenLink, 30},
    {sipName_OpenLinkInNewWindow, QWebPage::OpenLinkInNewWindow, 30},
    {sipName_Outdent, QWebPage::Outdent, 30},
    {sipName_Paste, QWebPage::Paste, 30},
    {sipName_PasteAndMatchStyle, QWebPage::PasteAndMatchStyle, 30},
    {sipName_Redo, QWebPage::Redo, 30},
    {sipName_Reload, QWebPage::Reload, 30},
    {sipName_ReloadAndBypassCache, QWebPage::ReloadAndBypassCache, 30},
    {sipName_RemoveFormat, QWebPage::RemoveFormat, 30},
    {sipName_SelectAll, QWebPage::SelectAll, 30},
    {sipName_SelectEndOfBlock, QWebPage::SelectEndOfBlock, 30},
    {sipName_SelectEndOfDocument, QWebPage::SelectEndOfDocument, 30},
    {sipName_SelectEndOfLine, QWebPage::SelectEndOfLine, 30},
    {sipName_SelectNextChar, QWebPage::SelectNextChar, 30},
    {sipName_SelectNextLine, QWebPage::SelectNextLine, 30},
    {sipName_SelectNextWord, QWebPage::SelectNextWord, 30},
    {sipName_SelectPreviousChar, QWebPage::SelectPreviousChar, 30},
    {sipName_SelectPreviousLine, QWebPage::SelectPreviousLine, 30},
    {sipName_SelectPreviousWord, QWebPage::SelectPreviousWord, 30},
    {sipName_SelectStartOfBlock, QWebPage::SelectStartOfBlock, 30},
    {sipName_SelectStartOfDocument, QWebPage::SelectStartOfDocument, 30},
    {sipName_SelectStartOfLine, QWebPage::SelectStartOfLine, 30},
    {sipName_SetTextDirectionDefault, QWebPage::SetTextDirectionDefault, 30},
    {sipName_SetTextDirectionLeftToRight, QWebPage::SetTextDirectionLeftToRight, 30},
    {sipName_SetTextDirectionRightToLeft, QWebPage::SetTextDirectionRightToLeft, 30},
    {sipName_Stop, QWebPage::Stop, 30},
    {sipName_ToggleBold, QWebPage::ToggleBold, 30},
    {sipName_ToggleItalic, QWebPage::ToggleItalic, 30},
    {sipName_ToggleStrikethrough, QWebPage::ToggleStrikethrough, 30},
    {sipName_ToggleSubscript, QWebPage::ToggleSubscript, 30},
    {sipName_ToggleSuperscript, QWebPage::ToggleSuperscript, 30},
    {sipName_ToggleUnderline, QWebPage::ToggleUnderline, 30},
    {sipName_Undo, QWebPage::Undo, 30},
    {sipName_WebBrowserWindow, QWebPage::WebBrowserWindow, 31},
    {sipName_WebModalDialog, QWebPage::WebModalDialog, 31},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QWebPage[] = {
    {"restoreFrameStateRequested(QWebFrame *)", "\1QWebPage.restoreFrameStateRequested(QWebFrame)", 0},
    {"saveFrameStateRequested(QWebFrame *,QWebHistoryItem *)", "\1QWebPage.saveFrameStateRequested(QWebFrame, QWebHistoryItem)", 0},
    {"databaseQuotaExceeded(QWebFrame *,QString)", "\1QWebPage.databaseQuotaExceeded(QWebFrame, QString)", 0},
    {"contentsChanged()", "\1QWebPage.contentsChanged()", 0},
    {"microFocusChanged()", "\1QWebPage.microFocusChanged()", 0},
    {"downloadRequested(const QNetworkRequest&)", "\1QWebPage.downloadRequested(QNetworkRequest)", 0},
    {"unsupportedContent(QNetworkReply *)", "\1QWebPage.unsupportedContent(QNetworkReply)", 0},
    {"menuBarVisibilityChangeRequested(bool)", "\1QWebPage.menuBarVisibilityChangeRequested(bool)", 0},
    {"statusBarVisibilityChangeRequested(bool)", "\1QWebPage.statusBarVisibilityChangeRequested(bool)", 0},
    {"toolBarVisibilityChangeRequested(bool)", "\1QWebPage.toolBarVisibilityChangeRequested(bool)", 0},
    {"linkClicked(const QUrl&)", "\1QWebPage.linkClicked(QUrl)", 0},
    {"printRequested(QWebFrame *)", "\1QWebPage.printRequested(QWebFrame)", 0},
    {"windowCloseRequested()", "\1QWebPage.windowCloseRequested()", 0},
    {"scrollRequested(int,int,const QRect&)", "\1QWebPage.scrollRequested(int, int, QRect)", 0},
    {"repaintRequested(const QRect&)", "\1QWebPage.repaintRequested(QRect)", 0},
    {"geometryChangeRequested(const QRect&)", "\1QWebPage.geometryChangeRequested(QRect)", 0},
    {"frameCreated(QWebFrame *)", "\1QWebPage.frameCreated(QWebFrame)", 0},
    {"selectionChanged()", "\1QWebPage.selectionChanged()", 0},
    {"statusBarMessage(const QString&)", "\1QWebPage.statusBarMessage(QString)", 0},
    {"linkHovered(const QString&,const QString&,const QString&)", "\1QWebPage.linkHovered(QString, QString, QString)", 0},
    {"loadStarted()", "\1QWebPage.loadStarted()", 0},
    {"loadProgress(int)", "\1QWebPage.loadProgress(int)", 0},
    {"loadFinished(bool)", "\1QWebPage.loadFinished(bool)", 0},
    {0, 0, 0}
};
