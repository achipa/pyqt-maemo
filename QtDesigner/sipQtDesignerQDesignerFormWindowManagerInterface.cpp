...
static const pyqt4QtSignal pyqt4_signals_QDesignerFormWindowManagerInterface[] = {
    {"activeFormWindowChanged(QDesignerFormWindowInterface *)", "\1QDesignerFormWindowManagerInterface.activeFormWindowChanged(QDesignerFormWindowInterface)", 0},
    {"formWindowRemoved(QDesignerFormWindowInterface *)", "\1QDesignerFormWindowManagerInterface.formWindowRemoved(QDesignerFormWindowInterface)", 0},
    {"formWindowAdded(QDesignerFormWindowInterface *)", "\1QDesignerFormWindowManagerInterface.formWindowAdded(QDesignerFormWindowInterface)", 0},
    {0, 0, 0}
};
