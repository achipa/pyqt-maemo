...
static sipEncodedTypeDef supers_QLineEdit[] = {{741, 255, 1}};
...
static sipEnumMemberDef enummembers_QLineEdit[] = {
    {sipName_NoEcho, QLineEdit::NoEcho, 275},
    {sipName_Normal, QLineEdit::Normal, 275},
    {sipName_Password, QLineEdit::Password, 275},
    {sipName_PasswordEchoOnEdit, QLineEdit::PasswordEchoOnEdit, 275},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QLineEdit[] = {
    {"selectionChanged()", "\1QLineEdit.selectionChanged()", 0},
    {"editingFinished()", "\1QLineEdit.editingFinished()", 0},
    {"returnPressed()", "\1QLineEdit.returnPressed()", 0},
    {"cursorPositionChanged(int,int)", "\1QLineEdit.cursorPositionChanged(int, int)", 0},
    {"textEdited(const QString&)", "\1QLineEdit.textEdited(QString)", 0},
    {"textChanged(const QString&)", "\1QLineEdit.textChanged(QString)", 0},
    {0, 0, 0}
};
