...
static sipEncodedTypeDef supers_QActionGroup[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QActionGroup[] = {
    {"hovered(QAction *)", "\1QActionGroup.hovered(QAction)", 0},
    {"selected(QAction *)", "\1QActionGroup.selected(QAction)", 0},
    {"triggered(QAction *)", "\1QActionGroup.triggered(QAction)", 0},
    {0, 0, 0}
};
