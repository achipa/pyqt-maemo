...
static sipEncodedTypeDef supers_QItemSelectionModel[] = {{129, 0, 1}};
...
static sipEnumMemberDef enummembers_QItemSelectionModel[] = {
    {sipName_Clear, QItemSelectionModel::Clear, 258},
    {sipName_ClearAndSelect, QItemSelectionModel::ClearAndSelect, 258},
    {sipName_Columns, QItemSelectionModel::Columns, 258},
    {sipName_Current, QItemSelectionModel::Current, 258},
    {sipName_Deselect, QItemSelectionModel::Deselect, 258},
    {sipName_NoUpdate, QItemSelectionModel::NoUpdate, 258},
    {sipName_Rows, QItemSelectionModel::Rows, 258},
    {sipName_Select, QItemSelectionModel::Select, 258},
    {sipName_SelectCurrent, QItemSelectionModel::SelectCurrent, 258},
    {sipName_Toggle, QItemSelectionModel::Toggle, 258},
    {sipName_ToggleCurrent, QItemSelectionModel::ToggleCurrent, 258},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QItemSelectionModel[] = {
    {"currentColumnChanged(const QModelIndex&,const QModelIndex&)", "\1QItemSelectionModel.currentColumnChanged(QModelIndex, QModelIndex)", 0},
    {"currentRowChanged(const QModelIndex&,const QModelIndex&)", "\1QItemSelectionModel.currentRowChanged(QModelIndex, QModelIndex)", 0},
    {"currentChanged(const QModelIndex&,const QModelIndex&)", "\1QItemSelectionModel.currentChanged(QModelIndex, QModelIndex)", 0},
    {"selectionChanged(const QItemSelection&,const QItemSelection&)", "\1QItemSelectionModel.selectionChanged(QItemSelection, QItemSelection)", 0},
    {0, 0, 0}
};
