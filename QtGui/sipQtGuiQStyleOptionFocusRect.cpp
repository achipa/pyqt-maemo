...
static sipEncodedTypeDef supers_QStyleOptionFocusRect[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionFocusRect[] = {
    {sipName_Type, QStyleOptionFocusRect::Type, 507},
    {sipName_Version, QStyleOptionFocusRect::Version, 508},
};
