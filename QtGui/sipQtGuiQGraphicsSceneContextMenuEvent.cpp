...
static void dealloc_QGraphicsSceneContextMenuEvent(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QGraphicsSceneContextMenuEvent(sipSelf->u.cppPtr,0);
    }
}


/* Define this type's super-types. */
static sipEncodedTypeDef supers_QGraphicsSceneContextMenuEvent[] = {{197, 255, 1}};
...
static sipEnumMemberDef enummembers_QGraphicsSceneContextMenuEvent[] = {
    {sipName_Keyboard, QGraphicsSceneContextMenuEvent::Keyboard, 195},
    {sipName_Mouse, QGraphicsSceneContextMenuEvent::Mouse, 195},
    {sipName_Other, QGraphicsSceneContextMenuEvent::Other, 195},
};
