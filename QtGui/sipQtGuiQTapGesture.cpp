...
#line 161 "/home/maemo/python-qt4-4.7/sip/QtGui/qgesture.sip"
#include <qgesture.h>
...
static void dealloc_QTapGesture(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQTapGesture *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QTapGesture(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QTapGesture[] = {{145, 255, 1}};
