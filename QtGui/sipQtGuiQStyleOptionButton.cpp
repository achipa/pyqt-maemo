...
static sipEncodedTypeDef supers_QStyleOptionButton[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionButton[] = {
    {sipName_AutoDefaultButton, QStyleOptionButton::AutoDefaultButton, 491},
    {sipName_CommandLinkButton, QStyleOptionButton::CommandLinkButton, 491},
    {sipName_DefaultButton, QStyleOptionButton::DefaultButton, 491},
    {sipName_Flat, QStyleOptionButton::Flat, 491},
    {sipName_HasMenu, QStyleOptionButton::HasMenu, 491},
    {sipName_None, QStyleOptionButton::None, 491},
    {sipName_Type, QStyleOptionButton::Type, 493},
    {sipName_Version, QStyleOptionButton::Version, 494},
};
