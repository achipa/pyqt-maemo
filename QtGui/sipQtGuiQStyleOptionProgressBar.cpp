...
static sipEncodedTypeDef supers_QStyleOptionProgressBar[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionProgressBar[] = {
    {sipName_Type, QStyleOptionProgressBar::Type, 536},
    {sipName_Version, QStyleOptionProgressBar::Version, 537},
};
