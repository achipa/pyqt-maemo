...
static sipEncodedTypeDef supers_QStyleOptionGraphicsItem[] = {{486, 255, 1}};
...
static sipEnumMemberDef enummembers_QStyleOptionGraphicsItem[] = {
    {sipName_Type, QStyleOptionGraphicsItem::Type, 519},
    {sipName_Version, QStyleOptionGraphicsItem::Version, 520},
};
