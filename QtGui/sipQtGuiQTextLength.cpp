...
static void *init_QTextLength(sipSimpleWrapper *, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **, PyObject **sipParseErr)
{
...

    {
        ...
        {
#line 61 "/home/maemo/python-qt4-4.7/sip/QtGui/qtextformat.sip"
        sipCpp = new QTextLength(qVariantValue<QTextLength>(*a0));
#line 301 "sipQtGuiQTextLength.cpp"
...
static sipEnumMemberDef enummembers_QTextLength[] = {
    {sipName_FixedLength, QTextLength::FixedLength, 679},
    {sipName_PercentageLength, QTextLength::PercentageLength, 679},
    {sipName_VariableLength, QTextLength::VariableLength, 679},
};
