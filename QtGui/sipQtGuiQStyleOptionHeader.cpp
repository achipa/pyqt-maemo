...
static sipEncodedTypeDef supers_QStyleOptionHeader[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionHeader[] = {
    {sipName_Beginning, QStyleOptionHeader::Beginning, 525},
    {sipName_End, QStyleOptionHeader::End, 525},
    {sipName_Middle, QStyleOptionHeader::Middle, 525},
    {sipName_NextAndPreviousAreSelected, QStyleOptionHeader::NextAndPreviousAreSelected, 526},
    {sipName_NextIsSelected, QStyleOptionHeader::NextIsSelected, 526},
    {sipName_None, QStyleOptionHeader::None, 527},
    {sipName_NotAdjacent, QStyleOptionHeader::NotAdjacent, 526},
    {sipName_OnlyOneSection, QStyleOptionHeader::OnlyOneSection, 525},
    {sipName_PreviousIsSelected, QStyleOptionHeader::PreviousIsSelected, 526},
    {sipName_SortDown, QStyleOptionHeader::SortDown, 527},
    {sipName_SortUp, QStyleOptionHeader::SortUp, 527},
    {sipName_Type, QStyleOptionHeader::Type, 528},
    {sipName_Version, QStyleOptionHeader::Version, 529},
};
