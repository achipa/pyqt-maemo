...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtGui/qimagereader.sip"
...
static sipEncodedTypeDef supers_QMovie[] = {{129, 0, 1}};
...
static sipEnumMemberDef enummembers_QMovie[] = {
    {sipName_CacheAll, QMovie::CacheAll, 352},
    {sipName_CacheNone, QMovie::CacheNone, 352},
    {sipName_NotRunning, QMovie::NotRunning, 353},
    {sipName_Paused, QMovie::Paused, 353},
    {sipName_Running, QMovie::Running, 353},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QMovie[] = {
    {"frameChanged(int)", "\1QMovie.frameChanged(int)", 0},
    {"finished()", "\1QMovie.finished()", 0},
    {"error(QImageReader::ImageReaderError)", "\1QMovie.error(QImageReader.ImageReaderError)", 0},
    {"stateChanged(QMovie::MovieState)", "\1QMovie.stateChanged(QMovie.MovieState)", 0},
    {"updated(const QRect&)", "\1QMovie.updated(QRect)", 0},
    {"resized(const QSize&)", "\1QMovie.resized(QSize)", 0},
    {"started()", "\1QMovie.started()", 0},
    {0, 0, 0}
};
