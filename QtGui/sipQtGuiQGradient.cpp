...
static sipEnumMemberDef enummembers_QGradient[] = {
    {sipName_ConicalGradient, QGradient::ConicalGradient, 154},
    {sipName_LinearGradient, QGradient::LinearGradient, 154},
    {sipName_LogicalMode, QGradient::LogicalMode, 152},
    {sipName_NoGradient, QGradient::NoGradient, 154},
    {sipName_ObjectBoundingMode, QGradient::ObjectBoundingMode, 152},
    {sipName_PadSpread, QGradient::PadSpread, 153},
    {sipName_RadialGradient, QGradient::RadialGradient, 154},
    {sipName_ReflectSpread, QGradient::ReflectSpread, 153},
    {sipName_RepeatSpread, QGradient::RepeatSpread, 153},
    {sipName_StretchToDeviceMode, QGradient::StretchToDeviceMode, 152},
};
