...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtGui/qtreeview.sip"
#include <qtreeview.h>
...
static PyObject *meth_QTreeView_setHeader(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QTreeView, &sipCpp, sipType_QHeaderView, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setHeader(a0);
            Py_END_ALLOW_THREADS
...
PyDoc_STRVAR(doc_QTreeView_doItemsLayout, "QTreeView.doItemsLayout()");
...
static PyObject *meth_QTreeView_doItemsLayout(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QTreeView, sipName_doItemsLayout, doc_QTreeView_doItemsLayout);
...
static PyMethodDef methods_QTreeView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_doItemsLayout), meth_QTreeView_doItemsLayout, METH_VARARGS, SIP_MLDOC_CAST(doc_QTreeView_doItemsLayout)},
...
static const pyqt4QtSignal pyqt4_signals_QTreeView[] = {
    {"collapsed(const QModelIndex&)", "\1QTreeView.collapsed(QModelIndex)", 0},
    {"expanded(const QModelIndex&)", "\1QTreeView.expanded(QModelIndex)", 0},
    {0, 0, 0}
};
