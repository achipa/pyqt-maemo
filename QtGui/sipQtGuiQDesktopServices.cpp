...
static PyObject *meth_QDesktopServices_setUrlHandler(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        {
#line 67 "/home/maemo/python-qt4-4.7/sip/QtGui/qdesktopservices.sip"
...
#line 146 "sipQtGuiQDesktopServices.cpp"
            sipReleaseType(const_cast<QString *>(a0),sipType_QString,a0State);
...
static PyMethodDef methods_QDesktopServices[] = {
    ...
    {SIP_MLNAME_CAST(sipName_setUrlHandler), (PyCFunction)meth_QDesktopServices_setUrlHandler, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QDesktopServices_setUrlHandler)},
...
static sipEnumMemberDef enummembers_QDesktopServices[] = {
    {sipName_ApplicationsLocation, QDesktopServices::ApplicationsLocation, 80},
    {sipName_CacheLocation, QDesktopServices::CacheLocation, 80},
    {sipName_DataLocation, QDesktopServices::DataLocation, 80},
    {sipName_DesktopLocation, QDesktopServices::DesktopLocation, 80},
    {sipName_DocumentsLocation, QDesktopServices::DocumentsLocation, 80},
    {sipName_FontsLocation, QDesktopServices::FontsLocation, 80},
    {sipName_HomeLocation, QDesktopServices::HomeLocation, 80},
    {sipName_MoviesLocation, QDesktopServices::MoviesLocation, 80},
    {sipName_MusicLocation, QDesktopServices::MusicLocation, 80},
    {sipName_PicturesLocation, QDesktopServices::PicturesLocation, 80},
    {sipName_TempLocation, QDesktopServices::TempLocation, 80},
};
