...
static sipEncodedTypeDef supers_QTextDocument[] = {{129, 0, 1}};
...
static PyMethodDef methods_QTextDocument[] = {
    ...
    {SIP_MLNAME_CAST(sipName_print), (PyCFunction)meth_QTextDocument_print, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QTextDocument_print)},
...
static sipEnumMemberDef enummembers_QTextDocument[] = {
    {sipName_DocumentTitle, QTextDocument::DocumentTitle, 649},
    {sipName_DocumentUrl, QTextDocument::DocumentUrl, 649},
    {sipName_FindBackward, QTextDocument::FindBackward, 647},
    {sipName_FindCaseSensitively, QTextDocument::FindCaseSensitively, 647},
    {sipName_FindWholeWords, QTextDocument::FindWholeWords, 647},
    {sipName_HtmlResource, QTextDocument::HtmlResource, 650},
    {sipName_ImageResource, QTextDocument::ImageResource, 650},
    {sipName_StyleSheetResource, QTextDocument::StyleSheetResource, 650},
    {sipName_UserResource, QTextDocument::UserResource, 650},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QTextDocument[] = {
    {"documentLayoutChanged()", "\1QTextDocument.documentLayoutChanged()", 0},
    {"undoCommandAdded()", "\1QTextDocument.undoCommandAdded()", 0},
    {"undoAvailable(bool)", "\1QTextDocument.undoAvailable(bool)", 0},
    {"redoAvailable(bool)", "\1QTextDocument.redoAvailable(bool)", 0},
    {"modificationChanged(bool)", "\1QTextDocument.modificationChanged(bool)", 0},
    {"cursorPositionChanged(const QTextCursor&)", "\1QTextDocument.cursorPositionChanged(QTextCursor)", 0},
    {"contentsChanged()", "\1QTextDocument.contentsChanged()", 0},
    {"contentsChange(int,int,int)", "\1QTextDocument.contentsChange(int, int, int)", 0},
    {"blockCountChanged(int)", "\1QTextDocument.blockCountChanged(int)", 0},
    {0, 0, 0}
};
