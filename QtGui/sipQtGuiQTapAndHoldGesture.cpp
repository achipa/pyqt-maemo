...
#line 177 "/home/maemo/python-qt4-4.7/sip/QtGui/qgesture.sip"
#include <qgesture.h>
...
static void dealloc_QTapAndHoldGesture(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQTapAndHoldGesture *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QTapAndHoldGesture(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QTapAndHoldGesture[] = {{145, 255, 1}};
