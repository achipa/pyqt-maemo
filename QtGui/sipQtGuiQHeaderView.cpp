...
PyDoc_STRVAR(doc_QHeaderView_doItemsLayout, "QHeaderView.doItemsLayout()");
...
static PyObject *meth_QHeaderView_doItemsLayout(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QHeaderView, sipName_doItemsLayout, doc_QHeaderView_doItemsLayout);
...
static PyMethodDef methods_QHeaderView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_doItemsLayout), meth_QHeaderView_doItemsLayout, METH_VARARGS, SIP_MLDOC_CAST(doc_QHeaderView_doItemsLayout)},
...
static sipEnumMemberDef enummembers_QHeaderView[] = {
    {sipName_Custom, QHeaderView::Custom, 220},
    {sipName_Fixed, QHeaderView::Fixed, 220},
    {sipName_Interactive, QHeaderView::Interactive, 220},
    {sipName_ResizeToContents, QHeaderView::ResizeToContents, 220},
    {sipName_Stretch, QHeaderView::Stretch, 220},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QHeaderView[] = {
    {"sortIndicatorChanged(int,Qt::SortOrder)", "\1QHeaderView.sortIndicatorChanged(int, Qt.SortOrder)", 0},
    {"sectionEntered(int)", "\1QHeaderView.sectionEntered(int)", 0},
    {"sectionAutoResize(int,QHeaderView::ResizeMode)", "\1QHeaderView.sectionAutoResize(int, QHeaderView.ResizeMode)", 0},
    {"sectionHandleDoubleClicked(int)", "\1QHeaderView.sectionHandleDoubleClicked(int)", 0},
    {"sectionCountChanged(int,int)", "\1QHeaderView.sectionCountChanged(int, int)", 0},
    {"sectionDoubleClicked(int)", "\1QHeaderView.sectionDoubleClicked(int)", 0},
    {"sectionClicked(int)", "\1QHeaderView.sectionClicked(int)", 0},
    {"sectionPressed(int)", "\1QHeaderView.sectionPressed(int)", 0},
    {"sectionResized(int,int,int)", "\1QHeaderView.sectionResized(int, int, int)", 0},
    {"sectionMoved(int,int,int)", "\1QHeaderView.sectionMoved(int, int, int)", 0},
    {"geometriesChanged()", "\1QHeaderView.geometriesChanged()", 0},
    {0, 0, 0}
};
