...
static sipEncodedTypeDef supers_QLayout[] = {{129, 0, 0}, {273, 255, 1}};
...
static sipEnumMemberDef enummembers_QLayout[] = {
    {sipName_SetDefaultConstraint, QLayout::SetDefaultConstraint, 272},
    {sipName_SetFixedSize, QLayout::SetFixedSize, 272},
    {sipName_SetMaximumSize, QLayout::SetMaximumSize, 272},
    {sipName_SetMinAndMaxSize, QLayout::SetMinAndMaxSize, 272},
    {sipName_SetMinimumSize, QLayout::SetMinimumSize, 272},
    {sipName_SetNoConstraint, QLayout::SetNoConstraint, 272},
};
