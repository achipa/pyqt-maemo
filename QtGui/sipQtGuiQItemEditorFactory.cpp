...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtGui/qitemeditorfactory.sip"
#include <qitemeditorfactory.h>
...
PyDoc_STRVAR(doc_QItemEditorFactory_createEditor, "QItemEditorFactory.createEditor(QVariant.Type, QWidget) -> QWidget");
...
PyDoc_STRVAR(doc_QItemEditorFactory_valuePropertyName, "QItemEditorFactory.valuePropertyName(QVariant.Type) -> QByteArray");
...
PyDoc_STRVAR(doc_QItemEditorFactory_registerEditor, "QItemEditorFactory.registerEditor(QVariant.Type, QItemEditorCreatorBase)");
