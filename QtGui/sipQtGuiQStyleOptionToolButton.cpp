...
static sipEncodedTypeDef supers_QStyleOptionToolButton[] = {{498, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionToolButton[] = {
    {sipName_Arrow, QStyleOptionToolButton::Arrow, 593},
    {sipName_HasMenu, QStyleOptionToolButton::HasMenu, 593},
    {sipName_Menu, QStyleOptionToolButton::Menu, 593},
    {sipName_MenuButtonPopup, QStyleOptionToolButton::MenuButtonPopup, 593},
    {sipName_None, QStyleOptionToolButton::None, 593},
    {sipName_PopupDelay, QStyleOptionToolButton::PopupDelay, 593},
    {sipName_Type, QStyleOptionToolButton::Type, 591},
    {sipName_Version, QStyleOptionToolButton::Version, 592},
};
