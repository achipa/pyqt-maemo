...
static sipEncodedTypeDef supers_QStyleOptionViewItem[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionViewItem[] = {
    {sipName_Bottom, QStyleOptionViewItem::Bottom, 596},
    {sipName_Left, QStyleOptionViewItem::Left, 596},
    {sipName_Right, QStyleOptionViewItem::Right, 596},
    {sipName_Top, QStyleOptionViewItem::Top, 596},
    {sipName_Type, QStyleOptionViewItem::Type, 597},
    {sipName_Version, QStyleOptionViewItem::Version, 598},
};
