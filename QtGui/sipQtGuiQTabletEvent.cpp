...
static sipEncodedTypeDef supers_QTabletEvent[] = {{248, 255, 1}};
...
static sipEnumMemberDef enummembers_QTabletEvent[] = {
    {sipName_Airbrush, QTabletEvent::Airbrush, 630},
    {sipName_Cursor, QTabletEvent::Cursor, 629},
    {sipName_Eraser, QTabletEvent::Eraser, 629},
    {sipName_FourDMouse, QTabletEvent::FourDMouse, 630},
    {sipName_NoDevice, QTabletEvent::NoDevice, 630},
    {sipName_Pen, QTabletEvent::Pen, 629},
    {sipName_Puck, QTabletEvent::Puck, 630},
    {sipName_RotationStylus, QTabletEvent::RotationStylus, 630},
    {sipName_Stylus, QTabletEvent::Stylus, 630},
    {sipName_UnknownPointer, QTabletEvent::UnknownPointer, 629},
    {sipName_XFreeEraser, QTabletEvent::XFreeEraser, 630},
};
