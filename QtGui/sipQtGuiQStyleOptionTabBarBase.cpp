...
static sipEncodedTypeDef supers_QStyleOptionTabBarBase[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTabBarBase[] = {
    {sipName_Type, QStyleOptionTabBarBase::Type, 561},
    {sipName_Version, QStyleOptionTabBarBase::Version, 562},
};
