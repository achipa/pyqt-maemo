...
static sipEncodedTypeDef supers_QStyleOptionTab[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTab[] = {
    {sipName_Beginning, QStyleOptionTab::Beginning, 559},
    {sipName_End, QStyleOptionTab::End, 559},
    {sipName_LeftCornerWidget, QStyleOptionTab::LeftCornerWidget, 554},
    {sipName_Middle, QStyleOptionTab::Middle, 559},
    {sipName_NextIsSelected, QStyleOptionTab::NextIsSelected, 556},
    {sipName_NoCornerWidgets, QStyleOptionTab::NoCornerWidgets, 554},
    {sipName_NotAdjacent, QStyleOptionTab::NotAdjacent, 556},
    {sipName_OnlyOneTab, QStyleOptionTab::OnlyOneTab, 559},
    {sipName_PreviousIsSelected, QStyleOptionTab::PreviousIsSelected, 556},
    {sipName_RightCornerWidget, QStyleOptionTab::RightCornerWidget, 554},
    {sipName_Type, QStyleOptionTab::Type, 557},
    {sipName_Version, QStyleOptionTab::Version, 558},
};
