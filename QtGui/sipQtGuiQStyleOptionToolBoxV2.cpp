...
static sipEncodedTypeDef supers_QStyleOptionToolBoxV2[] = {{583, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionToolBoxV2[] = {
    {sipName_Beginning, QStyleOptionToolBoxV2::Beginning, 589},
    {sipName_End, QStyleOptionToolBoxV2::End, 589},
    {sipName_Middle, QStyleOptionToolBoxV2::Middle, 589},
    {sipName_NextIsSelected, QStyleOptionToolBoxV2::NextIsSelected, 587},
    {sipName_NotAdjacent, QStyleOptionToolBoxV2::NotAdjacent, 587},
    {sipName_OnlyOneTab, QStyleOptionToolBoxV2::OnlyOneTab, 589},
    {sipName_PreviousIsSelected, QStyleOptionToolBoxV2::PreviousIsSelected, 587},
    {sipName_Version, QStyleOptionToolBoxV2::Version, 588},
};
