...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtGui/qdatawidgetmapper.sip"
...
static sipEncodedTypeDef supers_QDataWidgetMapper[] = {{129, 0, 1}};
...
static sipEnumMemberDef enummembers_QDataWidgetMapper[] = {
    {sipName_AutoSubmit, QDataWidgetMapper::AutoSubmit, 74},
    {sipName_ManualSubmit, QDataWidgetMapper::ManualSubmit, 74},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QDataWidgetMapper[] = {
    {"currentIndexChanged(int)", "\1QDataWidgetMapper.currentIndexChanged(int)", 0},
    {0, 0, 0}
};
