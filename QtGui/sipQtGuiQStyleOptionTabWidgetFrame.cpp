...
static sipEncodedTypeDef supers_QStyleOptionTabWidgetFrame[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTabWidgetFrame[] = {
    {sipName_Type, QStyleOptionTabWidgetFrame::Type, 570},
    {sipName_Version, QStyleOptionTabWidgetFrame::Version, 571},
};
