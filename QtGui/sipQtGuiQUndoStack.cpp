...
static sipEncodedTypeDef supers_QUndoStack[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QUndoStack[] = {
    {"undoTextChanged(const QString&)", "\1QUndoStack.undoTextChanged(QString)", 0},
    {"redoTextChanged(const QString&)", "\1QUndoStack.redoTextChanged(QString)", 0},
    {"indexChanged(int)", "\1QUndoStack.indexChanged(int)", 0},
    {"cleanChanged(bool)", "\1QUndoStack.cleanChanged(bool)", 0},
    {"canUndoChanged(bool)", "\1QUndoStack.canUndoChanged(bool)", 0},
    {"canRedoChanged(bool)", "\1QUndoStack.canRedoChanged(bool)", 0},
    {0, 0, 0}
};
