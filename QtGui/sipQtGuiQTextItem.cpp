...
static sipEnumMemberDef enummembers_QTextItem[] = {
    {sipName_Overline, QTextItem::Overline, 673},
    {sipName_RightToLeft, QTextItem::RightToLeft, 673},
    {sipName_StrikeOut, QTextItem::StrikeOut, 673},
    {sipName_Underline, QTextItem::Underline, 673},
};
