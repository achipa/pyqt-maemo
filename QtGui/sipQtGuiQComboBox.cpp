...
static sipEncodedTypeDef supers_QComboBox[] = {{741, 255, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QComboBox[] = {
    {"highlighted(int)", "\1QComboBox.highlighted(int)", 0},
    {"highlighted(const QString&)", "\1QComboBox.highlighted(QString)", 0},
    {"currentIndexChanged(int)", "\1QComboBox.currentIndexChanged(int)", 0},
    {"currentIndexChanged(const QString&)", "\1QComboBox.currentIndexChanged(QString)", 0},
    {"activated(int)", "\1QComboBox.activated(int)", 0},
    {"activated(const QString&)", "\1QComboBox.activated(QString)", 0},
    {"editTextChanged(const QString&)", "\1QComboBox.editTextChanged(QString)", 0},
    {0, 0, 0}
};
