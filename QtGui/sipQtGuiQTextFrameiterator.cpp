...
static PyObject *slot_QTextFrame_iterator___isub__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        {
#line 120 "/home/maemo/python-qt4-4.7/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)--;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)++;
#line 203 "sipQtGuiQTextFrameiterator.cpp"
...
static PyObject *slot_QTextFrame_iterator___iadd__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArg, "1i", &a0))
        {
#line 110 "/home/maemo/python-qt4-4.7/sip/QtGui/qtextobject.sip"
            if (a0 > 0)
                while (a0--)
                    (*sipCpp)++;
            else if (a0 < 0)
                while (a0++)
                    (*sipCpp)--;
#line 250 "sipQtGuiQTextFrameiterator.cpp"
