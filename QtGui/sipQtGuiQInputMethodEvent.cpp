...
static sipEncodedTypeDef supers_QInputMethodEvent[] = {{56, 0, 1}};
...
static sipEnumMemberDef enummembers_QInputMethodEvent[] = {
    {sipName_Cursor, QInputMethodEvent::Cursor, 251},
    {sipName_Language, QInputMethodEvent::Language, 251},
    {sipName_Ruby, QInputMethodEvent::Ruby, 251},
    {sipName_Selection, QInputMethodEvent::Selection, 251},
    {sipName_TextFormat, QInputMethodEvent::TextFormat, 251},
};
