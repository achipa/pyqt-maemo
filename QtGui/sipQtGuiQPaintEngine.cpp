...
static sipEnumMemberDef enummembers_QPaintEngine[] = {
    {sipName_AllDirty, QPaintEngine::AllDirty, 360},
    {sipName_AllFeatures, QPaintEngine::AllFeatures, 362},
    {sipName_AlphaBlend, QPaintEngine::AlphaBlend, 362},
    {sipName_Antialiasing, QPaintEngine::Antialiasing, 362},
    {sipName_BlendModes, QPaintEngine::BlendModes, 362},
    {sipName_BrushStroke, QPaintEngine::BrushStroke, 362},
    {sipName_ConicalGradientFill, QPaintEngine::ConicalGradientFill, 362},
    {sipName_ConstantOpacity, QPaintEngine::ConstantOpacity, 362},
    {sipName_ConvexMode, QPaintEngine::ConvexMode, 364},
    {sipName_CoreGraphics, QPaintEngine::CoreGraphics, 365},
    {sipName_Direct3D, QPaintEngine::Direct3D, 365},
    {sipName_DirtyBackground, QPaintEngine::DirtyBackground, 360},
    {sipName_DirtyBackgroundMode, QPaintEngine::DirtyBackgroundMode, 360},
    {sipName_DirtyBrush, QPaintEngine::DirtyBrush, 360},
    {sipName_DirtyBrushOrigin, QPaintEngine::DirtyBrushOrigin, 360},
    {sipName_DirtyClipEnabled, QPaintEngine::DirtyClipEnabled, 360},
    {sipName_DirtyClipPath, QPaintEngine::DirtyClipPath, 360},
    {sipName_DirtyClipRegion, QPaintEngine::DirtyClipRegion, 360},
    {sipName_DirtyCompositionMode, QPaintEngine::DirtyCompositionMode, 360},
    {sipName_DirtyFont, QPaintEngine::DirtyFont, 360},
    {sipName_DirtyHints, QPaintEngine::DirtyHints, 360},
    {sipName_DirtyOpacity, QPaintEngine::DirtyOpacity, 360},
    {sipName_DirtyPen, QPaintEngine::DirtyPen, 360},
    {sipName_DirtyTransform, QPaintEngine::DirtyTransform, 360},
    {sipName_LinearGradientFill, QPaintEngine::LinearGradientFill, 362},
    {sipName_MacPrinter, QPaintEngine::MacPrinter, 365},
    {sipName_MaskedBrush, QPaintEngine::MaskedBrush, 362},
    {sipName_MaxUser, QPaintEngine::MaxUser, 365},
    {sipName_ObjectBoundingModeGradients, QPaintEngine::ObjectBoundingModeGradients, 362},
    {sipName_OddEvenMode, QPaintEngine::OddEvenMode, 364},
    {sipName_OpenGL, QPaintEngine::OpenGL, 365},
    {sipName_OpenGL2, QPaintEngine::OpenGL2, 365},
    {sipName_OpenVG, QPaintEngine::OpenVG, 365},
    {sipName_PaintBuffer, QPaintEngine::PaintBuffer, 365},
    {sipName_PaintOutsidePaintEvent, QPaintEngine::PaintOutsidePaintEvent, 362},
    {sipName_PainterPaths, QPaintEngine::PainterPaths, 362},
    {sipName_PatternBrush, QPaintEngine::PatternBrush, 362},
    {sipName_PatternTransform, QPaintEngine::PatternTransform, 362},
    {sipName_Pdf, QPaintEngine::Pdf, 365},
    {sipName_PerspectiveTransform, QPaintEngine::PerspectiveTransform, 362},
    {sipName_Picture, QPaintEngine::Picture, 365},
    {sipName_PixmapTransform, QPaintEngine::PixmapTransform, 362},
    {sipName_PolylineMode, QPaintEngine::PolylineMode, 364},
    {sipName_PorterDuff, QPaintEngine::PorterDuff, 362},
    {sipName_PostScript, QPaintEngine::PostScript, 365},
    {sipName_PrimitiveTransform, QPaintEngine::PrimitiveTransform, 362},
    {sipName_QWindowSystem, QPaintEngine::QWindowSystem, 365},
    {sipName_QuickDraw, QPaintEngine::QuickDraw, 365},
    {sipName_RadialGradientFill, QPaintEngine::RadialGradientFill, 362},
    {sipName_Raster, QPaintEngine::Raster, 365},
    {sipName_RasterOpModes, QPaintEngine::RasterOpModes, 362},
    {sipName_SVG, QPaintEngine::SVG, 365},
    {sipName_User, QPaintEngine::User, 365},
    {sipName_WindingMode, QPaintEngine::WindingMode, 364},
    {sipName_Windows, QPaintEngine::Windows, 365},
    {sipName_X11, QPaintEngine::X11, 365},
};
