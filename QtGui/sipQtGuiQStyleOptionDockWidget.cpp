...
static sipEncodedTypeDef supers_QStyleOptionDockWidget[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionDockWidget[] = {
    {sipName_Type, QStyleOptionDockWidget::Type, 502},
    {sipName_Version, QStyleOptionDockWidget::Version, 503},
};
