...
static sipEncodedTypeDef supers_QStyleOptionRubberBand[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionRubberBand[] = {
    {sipName_Type, QStyleOptionRubberBand::Type, 542},
    {sipName_Version, QStyleOptionRubberBand::Version, 543},
};
