...
static sipEnumMemberDef enummembers_QImageIOHandler[] = {
    {sipName_Animation, QImageIOHandler::Animation, 236},
    {sipName_BackgroundColor, QImageIOHandler::BackgroundColor, 236},
    {sipName_ClipRect, QImageIOHandler::ClipRect, 236},
    {sipName_CompressionRatio, QImageIOHandler::CompressionRatio, 236},
    {sipName_Description, QImageIOHandler::Description, 236},
    {sipName_Endianness, QImageIOHandler::Endianness, 236},
    {sipName_Gamma, QImageIOHandler::Gamma, 236},
    {sipName_IncrementalReading, QImageIOHandler::IncrementalReading, 236},
    {sipName_Name, QImageIOHandler::Name, 236},
    {sipName_Quality, QImageIOHandler::Quality, 236},
    {sipName_ScaledClipRect, QImageIOHandler::ScaledClipRect, 236},
    {sipName_ScaledSize, QImageIOHandler::ScaledSize, 236},
    {sipName_Size, QImageIOHandler::Size, 236},
    {sipName_SubType, QImageIOHandler::SubType, 236},
};
