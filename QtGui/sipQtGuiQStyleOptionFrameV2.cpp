...
static sipEncodedTypeDef supers_QStyleOptionFrameV2[] = {{509, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionFrameV2[] = {
    {sipName_Flat, QStyleOptionFrameV2::Flat, 513},
    {sipName_None, QStyleOptionFrameV2::None, 513},
    {sipName_Version, QStyleOptionFrameV2::Version, 515},
};
