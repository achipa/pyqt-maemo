...
PyDoc_STRVAR(doc_QPrinter_devType, "QPrinter.devType() -> int");
...
static PyObject *meth_QPrinter_devType(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    sipNoMethod(sipParseErr, sipName_QPrinter, sipName_devType, doc_QPrinter_devType);
...
static sipEncodedTypeDef supers_QPrinter[] = {{357, 255, 1}};
...
static PyMethodDef methods_QPrinter[] = {
    ...
    {SIP_MLNAME_CAST(sipName_devType), meth_QPrinter_devType, METH_VARARGS, SIP_MLDOC_CAST(doc_QPrinter_devType)},
...
static sipEnumMemberDef enummembers_QPrinter[] = {
    {sipName_A0, QPrinter::A0, 408},
    {sipName_A1, QPrinter::A1, 408},
    {sipName_A2, QPrinter::A2, 408},
    {sipName_A3, QPrinter::A3, 408},
    {sipName_A4, QPrinter::A4, 408},
    {sipName_A5, QPrinter::A5, 408},
    {sipName_A6, QPrinter::A6, 408},
    {sipName_A7, QPrinter::A7, 408},
    {sipName_A8, QPrinter::A8, 408},
    {sipName_A9, QPrinter::A9, 408},
    {sipName_Aborted, QPrinter::Aborted, 412},
    {sipName_Active, QPrinter::Active, 412},
    {sipName_AllPages, QPrinter::AllPages, 410},
    {sipName_Auto, QPrinter::Auto, 409},
    {sipName_B0, QPrinter::B0, 408},
    {sipName_B1, QPrinter::B1, 408},
    {sipName_B10, QPrinter::B10, 408},
    {sipName_B2, QPrinter::B2, 408},
    {sipName_B3, QPrinter::B3, 408},
    {sipName_B4, QPrinter::B4, 408},
    {sipName_B5, QPrinter::B5, 408},
    {sipName_B6, QPrinter::B6, 408},
    {sipName_B7, QPrinter::B7, 408},
    {sipName_B8, QPrinter::B8, 408},
    {sipName_B9, QPrinter::B9, 408},
    {sipName_C5E, QPrinter::C5E, 408},
    {sipName_Cassette, QPrinter::Cassette, 409},
    {sipName_Cicero, QPrinter::Cicero, 413},
    {sipName_Color, QPrinter::Color, 403},
    {sipName_Comm10E, QPrinter::Comm10E, 408},
    {sipName_Custom, QPrinter::Custom, 408},
    {sipName_DLE, QPrinter::DLE, 408},
    {sipName_DevicePixel, QPrinter::DevicePixel, 413},
    {sipName_Didot, QPrinter::Didot, 413},
    {sipName_DuplexAuto, QPrinter::DuplexAuto, 404},
    {sipName_DuplexLongSide, QPrinter::DuplexLongSide, 404},
    {sipName_DuplexNone, QPrinter::DuplexNone, 404},
    {sipName_DuplexShortSide, QPrinter::DuplexShortSide, 404},
    {sipName_Envelope, QPrinter::Envelope, 409},
    {sipName_EnvelopeManual, QPrinter::EnvelopeManual, 409},
    {sipName_Error, QPrinter::Error, 412},
    {sipName_Executive, QPrinter::Executive, 408},
    {sipName_FirstPageFirst, QPrinter::FirstPageFirst, 407},
    {sipName_Folio, QPrinter::Folio, 408},
    {sipName_FormSource, QPrinter::FormSource, 409},
    {sipName_GrayScale, QPrinter::GrayScale, 403},
    {sipName_HighResolution, QPrinter::HighResolution, 411},
    {sipName_Idle, QPrinter::Idle, 412},
    {sipName_Inch, QPrinter::Inch, 413},
    {sipName_Landscape, QPrinter::Landscape, 405},
    {sipName_LargeCapacity, QPrinter::LargeCapacity, 409},
    {sipName_LargeFormat, QPrinter::LargeFormat, 409},
    {sipName_LastPageFirst, QPrinter::LastPageFirst, 407},
    {sipName_Ledger, QPrinter::Ledger, 408},
    {sipName_Legal, QPrinter::Legal, 408},
    {sipName_Letter, QPrinter::Letter, 408},
    {sipName_Lower, QPrinter::Lower, 409},
    {sipName_Manual, QPrinter::Manual, 409},
    {sipName_MaxPageSource, QPrinter::MaxPageSource, 409},
    {sipName_Middle, QPrinter::Middle, 409},
    {sipName_Millimeter, QPrinter::Millimeter, 413},
    {sipName_NativeFormat, QPrinter::NativeFormat, 406},
    {sipName_OnlyOne, QPrinter::OnlyOne, 409},
    {sipName_PageRange, QPrinter::PageRange, 410},
    {sipName_PdfFormat, QPrinter::PdfFormat, 406},
    {sipName_Pica, QPrinter::Pica, 413},
    {sipName_Point, QPrinter::Point, 413},
    {sipName_Portrait, QPrinter::Portrait, 405},
    {sipName_PostScriptFormat, QPrinter::PostScriptFormat, 406},
    {sipName_PrinterResolution, QPrinter::PrinterResolution, 411},
    {sipName_ScreenResolution, QPrinter::ScreenResolution, 411},
    {sipName_Selection, QPrinter::Selection, 410},
    {sipName_SmallFormat, QPrinter::SmallFormat, 409},
    {sipName_Tabloid, QPrinter::Tabloid, 408},
    {sipName_Tractor, QPrinter::Tractor, 409},
};
