...
static sipEncodedTypeDef supers_QValidator[] = {{129, 0, 1}};


static PyMethodDef methods_QValidator[] = {
    {SIP_MLNAME_CAST(sipName_fixup), (PyCFunction)meth_QValidator_fixup, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QValidator_fixup)},
...
static sipEnumMemberDef enummembers_QValidator[] = {
    {sipName_Acceptable, QValidator::Acceptable, 723},
    {sipName_Intermediate, QValidator::Intermediate, 723},
    {sipName_Invalid, QValidator::Invalid, 723},
};
