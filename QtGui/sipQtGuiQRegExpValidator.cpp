...
#line 143 "/home/maemo/python-qt4-4.7/sip/QtGui/qvalidator.sip"
...
static sipEncodedTypeDef supers_QRegExpValidator[] = {{722, 255, 1}};
...
static PyMethodDef methods_QRegExpValidator[] = {
    ...
    {SIP_MLNAME_CAST(sipName_validate), (PyCFunction)meth_QRegExpValidator_validate, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QRegExpValidator_validate)}
};

PyDoc_STRVAR(doc_QRegExpValidator, "\1QRegExpValidator(QObject)\n"
