...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtGui/qmouseeventtransition.sip"
...
static void dealloc_QMouseEventTransition(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQMouseEventTransition *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QMouseEventTransition(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
