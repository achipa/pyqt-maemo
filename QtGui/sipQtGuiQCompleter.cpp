...
static sipEncodedTypeDef supers_QCompleter[] = {{129, 0, 1}};
...
static sipEnumMemberDef enummembers_QCompleter[] = {
    {sipName_CaseInsensitivelySortedModel, QCompleter::CaseInsensitivelySortedModel, 68},
    {sipName_CaseSensitivelySortedModel, QCompleter::CaseSensitivelySortedModel, 68},
    {sipName_InlineCompletion, QCompleter::InlineCompletion, 67},
    {sipName_PopupCompletion, QCompleter::PopupCompletion, 67},
    {sipName_UnfilteredPopupCompletion, QCompleter::UnfilteredPopupCompletion, 67},
    {sipName_UnsortedModel, QCompleter::UnsortedModel, 68},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QCompleter[] = {
    {"highlighted(const QString&)", "\1QCompleter.highlighted(QString)", 0},
    {"highlighted(const QModelIndex&)", "\1QCompleter.highlighted(QModelIndex)", 0},
    {"activated(const QString&)", "\1QCompleter.activated(QString)", 0},
    {"activated(const QModelIndex&)", "\1QCompleter.activated(QModelIndex)", 0},
    {0, 0, 0}
};
