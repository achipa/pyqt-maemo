...
static sipEnumMemberDef enummembers_QPrintEngine[] = {
    {sipName_PPK_CollateCopies, QPrintEngine::PPK_CollateCopies, 397},
    {sipName_PPK_ColorMode, QPrintEngine::PPK_ColorMode, 397},
    {sipName_PPK_Creator, QPrintEngine::PPK_Creator, 397},
    {sipName_PPK_CustomBase, QPrintEngine::PPK_CustomBase, 397},
    {sipName_PPK_CustomPaperSize, QPrintEngine::PPK_CustomPaperSize, 397},
    {sipName_PPK_DocumentName, QPrintEngine::PPK_DocumentName, 397},
    {sipName_PPK_Duplex, QPrintEngine::PPK_Duplex, 397},
    {sipName_PPK_FontEmbedding, QPrintEngine::PPK_FontEmbedding, 397},
    {sipName_PPK_FullPage, QPrintEngine::PPK_FullPage, 397},
    {sipName_PPK_NumberOfCopies, QPrintEngine::PPK_NumberOfCopies, 397},
    {sipName_PPK_Orientation, QPrintEngine::PPK_Orientation, 397},
    {sipName_PPK_OutputFileName, QPrintEngine::PPK_OutputFileName, 397},
    {sipName_PPK_PageMargins, QPrintEngine::PPK_PageMargins, 397},
    {sipName_PPK_PageOrder, QPrintEngine::PPK_PageOrder, 397},
    {sipName_PPK_PageRect, QPrintEngine::PPK_PageRect, 397},
    {sipName_PPK_PageSize, QPrintEngine::PPK_PageSize, 397},
    {sipName_PPK_PaperRect, QPrintEngine::PPK_PaperRect, 397},
    {sipName_PPK_PaperSize, QPrintEngine::PPK_PaperSize, 397},
    {sipName_PPK_PaperSource, QPrintEngine::PPK_PaperSource, 397},
    {sipName_PPK_PaperSources, QPrintEngine::PPK_PaperSources, 397},
    {sipName_PPK_PrinterName, QPrintEngine::PPK_PrinterName, 397},
    {sipName_PPK_PrinterProgram, QPrintEngine::PPK_PrinterProgram, 397},
    {sipName_PPK_Resolution, QPrintEngine::PPK_Resolution, 397},
    {sipName_PPK_SelectionOption, QPrintEngine::PPK_SelectionOption, 397},
    {sipName_PPK_SupportedResolutions, QPrintEngine::PPK_SupportedResolutions, 397},
    {sipName_PPK_SuppressSystemPrintStatus, QPrintEngine::PPK_SuppressSystemPrintStatus, 397},
    {sipName_PPK_WindowsPageSize, QPrintEngine::PPK_WindowsPageSize, 397},
};
