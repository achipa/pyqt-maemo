...
#line 136 "sipQtGuiQMessageBox.cpp"
#line 41 "/home/maemo/python-qt4-4.7/sip/QtGui/qfont.sip"
#include <qfont.h>
#line 139 "sipQtGuiQMessageBox.cpp"
#line 41 "/home/maemo/python-qt4-4.7/sip/QtGui/qpalette.sip"
#include <qpalette.h>
#line 142 "sipQtGuiQMessageBox.cpp"
#line 41 "/home/maemo/python-qt4-4.7/sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 145 "sipQtGuiQMessageBox.cpp"
...
static PyObject *meth_QMessageBox_setDefaultButton(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QMessageBox, &sipCpp, sipType_QPushButton, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QMessageBox[] = {
    {sipName_Abort, QMessageBox::Abort, 345},
    {sipName_AcceptRole, QMessageBox::AcceptRole, 343},
    {sipName_ActionRole, QMessageBox::ActionRole, 343},
    {sipName_Apply, QMessageBox::Apply, 345},
    {sipName_ApplyRole, QMessageBox::ApplyRole, 343},
    {sipName_ButtonMask, QMessageBox::ButtonMask, 345},
    {sipName_Cancel, QMessageBox::Cancel, 345},
    {sipName_Close, QMessageBox::Close, 345},
    {sipName_Critical, QMessageBox::Critical, 344},
    {sipName_Default, QMessageBox::Default, 345},
    {sipName_DestructiveRole, QMessageBox::DestructiveRole, 343},
    {sipName_Discard, QMessageBox::Discard, 345},
    {sipName_Escape, QMessageBox::Escape, 345},
    {sipName_FirstButton, QMessageBox::FirstButton, 345},
    {sipName_FlagMask, QMessageBox::FlagMask, 345},
    {sipName_Help, QMessageBox::Help, 345},
    {sipName_HelpRole, QMessageBox::HelpRole, 343},
    {sipName_Ignore, QMessageBox::Ignore, 345},
    {sipName_Information, QMessageBox::Information, 344},
    {sipName_InvalidRole, QMessageBox::InvalidRole, 343},
    {sipName_LastButton, QMessageBox::LastButton, 345},
    {sipName_No, QMessageBox::No, 345},
    {sipName_NoAll, QMessageBox::NoAll, 345},
    {sipName_NoButton, QMessageBox::NoButton, 345},
    {sipName_NoIcon, QMessageBox::NoIcon, 344},
    {sipName_NoRole, QMessageBox::NoRole, 343},
    {sipName_NoToAll, QMessageBox::NoToAll, 345},
    {sipName_Ok, QMessageBox::Ok, 345},
    {sipName_Open, QMessageBox::Open, 345},
    {sipName_Question, QMessageBox::Question, 344},
    {sipName_RejectRole, QMessageBox::RejectRole, 343},
    {sipName_Reset, QMessageBox::Reset, 345},
    {sipName_ResetRole, QMessageBox::ResetRole, 343},
    {sipName_RestoreDefaults, QMessageBox::RestoreDefaults, 345},
    {sipName_Retry, QMessageBox::Retry, 345},
    {sipName_Save, QMessageBox::Save, 345},
    {sipName_SaveAll, QMessageBox::SaveAll, 345},
    {sipName_Warning, QMessageBox::Warning, 344},
    {sipName_Yes, QMessageBox::Yes, 345},
    {sipName_YesAll, QMessageBox::YesAll, 345},
    {sipName_YesRole, QMessageBox::YesRole, 343},
    {sipName_YesToAll, QMessageBox::YesToAll, 345},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QMessageBox[] = {
    {"buttonClicked(QAbstractButton *)", "\1QMessageBox.buttonClicked(QAbstractButton)", 0},
    {0, 0, 0}
};
