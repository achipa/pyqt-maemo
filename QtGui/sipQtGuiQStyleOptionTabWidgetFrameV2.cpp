...
static void dealloc_QStyleOptionTabWidgetFrameV2(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QStyleOptionTabWidgetFrameV2(sipSelf->u.cppPtr,0);
    }
}
...
static sipEncodedTypeDef supers_QStyleOptionTabWidgetFrameV2[] = {{569, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionTabWidgetFrameV2[] = {
    {sipName_Version, QStyleOptionTabWidgetFrameV2::Version, 573},
};
