...
static sipEncodedTypeDef supers_QStyleOptionGroupBox[] = {{498, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionGroupBox[] = {
    {sipName_Type, QStyleOptionGroupBox::Type, 522},
    {sipName_Version, QStyleOptionGroupBox::Version, 523},
};
