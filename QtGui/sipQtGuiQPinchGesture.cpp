...
static void dealloc_QPinchGesture(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQPinchGesture *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QPinchGesture(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QPinchGesture[] = {{145, 255, 1}};
...
static sipEnumMemberDef enummembers_QPinchGesture[] = {
    {sipName_CenterPointChanged, QPinchGesture::CenterPointChanged, 384},
    {sipName_RotationAngleChanged, QPinchGesture::RotationAngleChanged, 384},
    {sipName_ScaleFactorChanged, QPinchGesture::ScaleFactorChanged, 384},
};
