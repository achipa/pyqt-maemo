...
static sipEncodedTypeDef supers_QStyleHintReturnVariant[] = {{476, 255, 1}};

static sipEnumMemberDef enummembers_QStyleHintReturnVariant[] = {
    {sipName_Type, QStyleHintReturnVariant::Type, 484},
    {sipName_Version, QStyleHintReturnVariant::Version, 485},
};
