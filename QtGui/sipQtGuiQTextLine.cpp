...
static sipEnumMemberDef enummembers_QTextLine[] = {
    {sipName_CursorBetweenCharacters, QTextLine::CursorBetweenCharacters, 681},
    {sipName_CursorOnCharacter, QTextLine::CursorOnCharacter, 681},
    {sipName_Leading, QTextLine::Leading, 682},
    {sipName_Trailing, QTextLine::Trailing, 682},
};
