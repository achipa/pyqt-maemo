...
#line 69 "/home/maemo/python-qt4-4.7/sip/QtGui/qgesture.sip"
#include <qgesture.h>
...
static void dealloc_QPanGesture(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQPanGesture *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QPanGesture(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QPanGesture[] = {{145, 255, 1}};
