...
static sipEncodedTypeDef supers_QStyleOptionMenuItem[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionMenuItem[] = {
    {sipName_DefaultItem, QStyleOptionMenuItem::DefaultItem, 532},
    {sipName_EmptyArea, QStyleOptionMenuItem::EmptyArea, 532},
    {sipName_Exclusive, QStyleOptionMenuItem::Exclusive, 531},
    {sipName_Margin, QStyleOptionMenuItem::Margin, 532},
    {sipName_NonExclusive, QStyleOptionMenuItem::NonExclusive, 531},
    {sipName_Normal, QStyleOptionMenuItem::Normal, 532},
    {sipName_NotCheckable, QStyleOptionMenuItem::NotCheckable, 531},
    {sipName_Scroller, QStyleOptionMenuItem::Scroller, 532},
    {sipName_Separator, QStyleOptionMenuItem::Separator, 532},
    {sipName_SubMenu, QStyleOptionMenuItem::SubMenu, 532},
    {sipName_TearOff, QStyleOptionMenuItem::TearOff, 532},
    {sipName_Type, QStyleOptionMenuItem::Type, 533},
    {sipName_Version, QStyleOptionMenuItem::Version, 534},
};
