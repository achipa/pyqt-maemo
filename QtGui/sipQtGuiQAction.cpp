...
static PyObject *meth_QAction_setActionGroup(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QAction, &sipCpp, sipType_QActionGroup, &a0))
        {
...
static PyObject *meth_QAction_setMenu(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QAction, &sipCpp, sipType_QMenu, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setMenu(a0);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QAction[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QAction[] = {
    {"toggled(bool)", "\1QAction.toggled(bool)", 0},
    {"hovered()", "\1QAction.hovered()", 0},
    {"triggered(bool)", "\1QAction.triggered(bool)", 0},
    {"triggered()", "\1QAction.triggered()", 0},
    {"changed()", "\1QAction.changed()", 0},
    {0, 0, 0}
};
