...
static sipEncodedTypeDef supers_QContextMenuEvent[] = {{248, 255, 1}};
...
static sipEnumMemberDef enummembers_QContextMenuEvent[] = {
    {sipName_Keyboard, QContextMenuEvent::Keyboard, 71},
    {sipName_Mouse, QContextMenuEvent::Mouse, 71},
    {sipName_Other, QContextMenuEvent::Other, 71},
};
