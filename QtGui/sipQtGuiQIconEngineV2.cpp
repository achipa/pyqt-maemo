...
static void dealloc_QIconEngineV2(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQIconEngineV2 *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QIconEngineV2(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QIconEngineV2[] = {{228, 255, 1}};
...
static sipEnumMemberDef enummembers_QIconEngineV2[] = {
    {sipName_AvailableSizesHook, QIconEngineV2::AvailableSizesHook, 231},
};
