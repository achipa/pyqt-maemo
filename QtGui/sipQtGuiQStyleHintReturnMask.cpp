...
static sipEncodedTypeDef supers_QStyleHintReturnMask[] = {{476, 255, 1}};

static sipEnumMemberDef enummembers_QStyleHintReturnMask[] = {
    {sipName_Type, QStyleHintReturnMask::Type, 481},
    {sipName_Version, QStyleHintReturnMask::Version, 482},
};
