...
static sipEncodedTypeDef supers_QUndoGroup[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QUndoGroup[] = {
    {"undoTextChanged(const QString&)", "\1QUndoGroup.undoTextChanged(QString)", 0},
    {"redoTextChanged(const QString&)", "\1QUndoGroup.redoTextChanged(QString)", 0},
    {"indexChanged(int)", "\1QUndoGroup.indexChanged(int)", 0},
    {"cleanChanged(bool)", "\1QUndoGroup.cleanChanged(bool)", 0},
    {"canUndoChanged(bool)", "\1QUndoGroup.canUndoChanged(bool)", 0},
    {"canRedoChanged(bool)", "\1QUndoGroup.canRedoChanged(bool)", 0},
    {"activeStackChanged(QUndoStack *)", "\1QUndoGroup.activeStackChanged(QUndoStack)", 0},
    {0, 0, 0}
};
