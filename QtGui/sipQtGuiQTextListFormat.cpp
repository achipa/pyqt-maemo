...
static sipEncodedTypeDef supers_QTextListFormat[] = {{658, 255, 1}};
...
static sipEnumMemberDef enummembers_QTextListFormat[] = {
    {sipName_ListCircle, QTextListFormat::ListCircle, 685},
    {sipName_ListDecimal, QTextListFormat::ListDecimal, 685},
    {sipName_ListDisc, QTextListFormat::ListDisc, 685},
    {sipName_ListLowerAlpha, QTextListFormat::ListLowerAlpha, 685},
    {sipName_ListLowerRoman, QTextListFormat::ListLowerRoman, 685},
    {sipName_ListSquare, QTextListFormat::ListSquare, 685},
    {sipName_ListUpperAlpha, QTextListFormat::ListUpperAlpha, 685},
    {sipName_ListUpperRoman, QTextListFormat::ListUpperRoman, 685},
};
