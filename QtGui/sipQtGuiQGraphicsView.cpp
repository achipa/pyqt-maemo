...
static PyObject *meth_QGraphicsView_drawItems(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pJ8TT", &sipSelf, sipType_QGraphicsView, &sipCpp, sipType_QPainter, &a0, &PyList_Type, &a1, &PyList_Type, &a2))
        {
            int sipIsErr = 0;

#line 172 "/home/maemo/python-qt4-4.7/sip/QtGui/qgraphicsview.sip"
        ...
        delete[] items;
        delete[] options;
#line 4034 "sipQtGuiQGraphicsView.cpp"
...
static PyMethodDef methods_QGraphicsView[] = {
    ...
    {SIP_MLNAME_CAST(sipName_drawItems), (PyCFunction)meth_QGraphicsView_drawItems, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QGraphicsView_drawItems)},
...
static sipEnumMemberDef enummembers_QGraphicsView[] = {
    {sipName_AnchorUnderMouse, QGraphicsView::AnchorUnderMouse, 213},
    {sipName_AnchorViewCenter, QGraphicsView::AnchorViewCenter, 213},
    {sipName_BoundingRectViewportUpdate, QGraphicsView::BoundingRectViewportUpdate, 214},
    {sipName_CacheBackground, QGraphicsView::CacheBackground, 209},
    {sipName_CacheNone, QGraphicsView::CacheNone, 209},
    {sipName_DontAdjustForAntialiasing, QGraphicsView::DontAdjustForAntialiasing, 211},
    {sipName_DontClipPainter, QGraphicsView::DontClipPainter, 211},
    {sipName_DontSavePainterState, QGraphicsView::DontSavePainterState, 211},
    {sipName_FullViewportUpdate, QGraphicsView::FullViewportUpdate, 214},
    {sipName_MinimalViewportUpdate, QGraphicsView::MinimalViewportUpdate, 214},
    {sipName_NoAnchor, QGraphicsView::NoAnchor, 213},
    {sipName_NoDrag, QGraphicsView::NoDrag, 210},
    {sipName_NoViewportUpdate, QGraphicsView::NoViewportUpdate, 214},
    {sipName_RubberBandDrag, QGraphicsView::RubberBandDrag, 210},
    {sipName_ScrollHandDrag, QGraphicsView::ScrollHandDrag, 210},
    {sipName_SmartViewportUpdate, QGraphicsView::SmartViewportUpdate, 214},
};
