...
static sipEncodedTypeDef supers_QStyleOptionToolBar[] = {{486, 255, 1}};

static sipEnumMemberDef enummembers_QStyleOptionToolBar[] = {
    {sipName_Beginning, QStyleOptionToolBar::Beginning, 582},
    {sipName_End, QStyleOptionToolBar::End, 582},
    {sipName_Middle, QStyleOptionToolBar::Middle, 582},
    {sipName_Movable, QStyleOptionToolBar::Movable, 580},
    {sipName_None, QStyleOptionToolBar::None, 580},
    {sipName_OnlyOne, QStyleOptionToolBar::OnlyOne, 582},
    {sipName_Type, QStyleOptionToolBar::Type, 578},
    {sipName_Version, QStyleOptionToolBar::Version, 579},
};
