...
#line 66 "/home/maemo/python-qt4-4.7/sip/QtGui/qclipboard.sip"
        QString *text;
...
#line 342 "sipQtGuiQClipboard.cpp"
...
static PyObject *meth_QClipboard_setMimeData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        {
#line 94 "/home/maemo/python-qt4-4.7/sip/QtGui/qclipboard.sip"
        Py_BEGIN_ALLOW_THREADS
...
#line 484 "sipQtGuiQClipboard.cpp"
...
static sipEncodedTypeDef supers_QClipboard[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QClipboard[] = {
    {"selectionChanged()", "\1QClipboard.selectionChanged()", 0},
    {"findBufferChanged()", "\1QClipboard.findBufferChanged()", 0},
    {"dataChanged()", "\1QClipboard.dataChanged()", 0},
    {"changed(QClipboard::Mode)", "\1QClipboard.changed(QClipboard.Mode)", 0},
    {0, 0, 0}
};
