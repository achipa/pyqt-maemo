...
static sipEncodedTypeDef supers_QButtonGroup[] = {{129, 0, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QButtonGroup[] = {
    {"buttonReleased(QAbstractButton *)", "\1QButtonGroup.buttonReleased(QAbstractButton)", 0},
    {"buttonReleased(int)", "\1QButtonGroup.buttonReleased(int)", 0},
    {"buttonPressed(QAbstractButton *)", "\1QButtonGroup.buttonPressed(QAbstractButton)", 0},
    {"buttonPressed(int)", "\1QButtonGroup.buttonPressed(int)", 0},
    {"buttonClicked(QAbstractButton *)", "\1QButtonGroup.buttonClicked(QAbstractButton)", 0},
    {"buttonClicked(int)", "\1QButtonGroup.buttonClicked(int)", 0},
    {0, 0, 0}
};
