...
extern "C" {static void *init_QHelpEngineCore(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_QHelpEngineCore(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static const pyqt4QtSignal pyqt4_signals_QHelpEngineCore[] = {
    {"warning(const QString&)", "\1QHelpEngineCore.warning(QString)", 0},
    {"currentFilterChanged(const QString&)", "\1QHelpEngineCore.currentFilterChanged(QString)", 0},
    {"setupFinished()", "\1QHelpEngineCore.setupFinished()", 0},
    {"setupStarted()", "\1QHelpEngineCore.setupStarted()", 0},
    {0, 0, 0}
};
