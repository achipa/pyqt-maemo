...
static void dealloc_QAbstractAnimation(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQAbstractAnimation *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QAbstractAnimation(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QAbstractAnimation[] = {{129, 255, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QAbstractAnimation[] = {
    {"directionChanged(QAbstractAnimation::Direction)", "\1QAbstractAnimation.directionChanged(QAbstractAnimation.Direction)", 0},
    {"currentLoopChanged(int)", "\1QAbstractAnimation.currentLoopChanged(int)", 0},
    {"stateChanged(QAbstractAnimation::State,QAbstractAnimation::State)", "\1QAbstractAnimation.stateChanged(QAbstractAnimation.State, QAbstractAnimation.State)", 0},
    {"finished()", "\1QAbstractAnimation.finished()", 0},
    {0, 0, 0}
};
