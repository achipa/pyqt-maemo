...
static sipEnumMemberDef enummembers_QTextStream[] = {
    {sipName_AlignAccountingStyle, QTextStream::AlignAccountingStyle, 208},
    {sipName_AlignCenter, QTextStream::AlignCenter, 208},
    {sipName_AlignLeft, QTextStream::AlignLeft, 208},
    {sipName_AlignRight, QTextStream::AlignRight, 208},
    {sipName_FixedNotation, QTextStream::FixedNotation, 211},
    {sipName_ForcePoint, QTextStream::ForcePoint, 209},
    {sipName_ForceSign, QTextStream::ForceSign, 209},
    {sipName_Ok, QTextStream::Ok, 212},
    {sipName_ReadCorruptData, QTextStream::ReadCorruptData, 212},
    {sipName_ReadPastEnd, QTextStream::ReadPastEnd, 212},
    {sipName_ScientificNotation, QTextStream::ScientificNotation, 211},
    {sipName_ShowBase, QTextStream::ShowBase, 209},
    {sipName_SmartNotation, QTextStream::SmartNotation, 211},
    {sipName_UppercaseBase, QTextStream::UppercaseBase, 209},
    {sipName_UppercaseDigits, QTextStream::UppercaseDigits, 209},
};
