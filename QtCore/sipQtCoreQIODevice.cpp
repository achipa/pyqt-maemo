...
#line 79 "/home/maemo/python-qt4-4.7/sip/QtCore/qiodevice.sip"
...
#line 1079 "sipQtCoreQIODevice.cpp"
...
#line 114 "/home/maemo/python-qt4-4.7/sip/QtCore/qiodevice.sip"
...
#line 1190 "sipQtCoreQIODevice.cpp"
...
static PyObject *meth_QIODevice_readData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pn", &sipSelf, sipType_QIODevice, &sipCpp, &a0))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;
...
#line 180 "/home/maemo/python-qt4-4.7/sip/QtCore/qiodevice.sip"
        // Return the data read or None if there was an error.
        if (a0 < 0)
        {
            PyErr_SetString(PyExc_ValueError, "maximum length of data to be read cannot be negative");
...
#line 1550 "sipQtCoreQIODevice.cpp"
...
#line 245 "/home/maemo/python-qt4-4.7/sip/QtCore/qiodevice.sip"
        // Return the data read or None if there was an error.
        if (a0 < 0)
        {
            PyErr_SetString(PyExc_ValueError, "maximum length of data to be read cannot be negative");
...
#line 1623 "sipQtCoreQIODevice.cpp"
...
static sipEncodedTypeDef supers_QIODevice[] = {{129, 255, 1}};
...
static PyMethodDef methods_QIODevice[] = {
    ...
    {SIP_MLNAME_CAST(sipName_read), (PyCFunction)meth_QIODevice_read, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QIODevice_read)},
...
static sipEnumMemberDef enummembers_QIODevice[] = {
    {sipName_Append, QIODevice::Append, 79},
    {sipName_NotOpen, QIODevice::NotOpen, 79},
    {sipName_ReadOnly, QIODevice::ReadOnly, 79},
    {sipName_ReadWrite, QIODevice::ReadWrite, 79},
    {sipName_Text, QIODevice::Text, 79},
    {sipName_Truncate, QIODevice::Truncate, 79},
    {sipName_Unbuffered, QIODevice::Unbuffered, 79},
    {sipName_WriteOnly, QIODevice::WriteOnly, 79},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QIODevice[] = {
    {"readChannelFinished()", "\1QIODevice.readChannelFinished()", 0},
    {"aboutToClose()", "\1QIODevice.aboutToClose()", 0},
    {"bytesWritten(qint64)", "\1QIODevice.bytesWritten(int)", 0},
    {"readyRead()", "\1QIODevice.readyRead()", 0},
    {0, 0, 0}
};
