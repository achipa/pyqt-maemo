...
static sipEncodedTypeDef supers_QTimeLine[] = {{129, 255, 1}};
...
static sipEnumMemberDef enummembers_QTimeLine[] = {
    {sipName_Backward, QTimeLine::Backward, 220},
    {sipName_CosineCurve, QTimeLine::CosineCurve, 219},
    {sipName_EaseInCurve, QTimeLine::EaseInCurve, 219},
    {sipName_EaseInOutCurve, QTimeLine::EaseInOutCurve, 219},
    {sipName_EaseOutCurve, QTimeLine::EaseOutCurve, 219},
    {sipName_Forward, QTimeLine::Forward, 220},
    {sipName_LinearCurve, QTimeLine::LinearCurve, 219},
    {sipName_NotRunning, QTimeLine::NotRunning, 221},
    {sipName_Paused, QTimeLine::Paused, 221},
    {sipName_Running, QTimeLine::Running, 221},
    {sipName_SineCurve, QTimeLine::SineCurve, 219},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QTimeLine[] = {
    {"valueChanged(qreal)", "\1QTimeLine.valueChanged(float)", 0},
    {"stateChanged(QTimeLine::State)", "\1QTimeLine.stateChanged(QTimeLine.State)", 0},
    {"frameChanged(int)", "\1QTimeLine.frameChanged(int)", 0},
    {"finished()", "\1QTimeLine.finished()", 0},
    {0, 0, 0}
};
