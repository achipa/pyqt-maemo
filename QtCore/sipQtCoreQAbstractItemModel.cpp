...
#line 224 "/home/maemo/python-qt4-4.7/sip/QtCore/qabstractitemmodel.sip"
        ...
        #endif
#line 2631 "sipQtCoreQAbstractItemModel.cpp"
...
static sipEncodedTypeDef supers_QAbstractItemModel[] = {{129, 255, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QAbstractItemModel[] = {
    {"columnsMoved(const QModelIndex&,int,int,const QModelIndex&,int)", "\1QAbstractItemModel.columnsMoved(QModelIndex, int, int, QModelIndex, int)", 0},
    {"columnsAboutToBeMoved(const QModelIndex&,int,int,const QModelIndex&,int)", "\1QAbstractItemModel.columnsAboutToBeMoved(QModelIndex, int, int, QModelIndex, int)", 0},
    {"rowsMoved(const QModelIndex&,int,int,const QModelIndex&,int)", "\1QAbstractItemModel.rowsMoved(QModelIndex, int, int, QModelIndex, int)", 0},
    {"rowsAboutToBeMoved(const QModelIndex&,int,int,const QModelIndex&,int)", "\1QAbstractItemModel.rowsAboutToBeMoved(QModelIndex, int, int, QModelIndex, int)", 0},
    {"modelReset()", "\1QAbstractItemModel.modelReset()", 0},
    {"modelAboutToBeReset()", "\1QAbstractItemModel.modelAboutToBeReset()", 0},
    {"columnsRemoved(const QModelIndex&,int,int)", "\1QAbstractItemModel.columnsRemoved(QModelIndex, int, int)", 0},
    {"columnsAboutToBeRemoved(const QModelIndex&,int,int)", "\1QAbstractItemModel.columnsAboutToBeRemoved(QModelIndex, int, int)", 0},
    {"columnsInserted(const QModelIndex&,int,int)", "\1QAbstractItemModel.columnsInserted(QModelIndex, int, int)", 0},
    {"columnsAboutToBeInserted(const QModelIndex&,int,int)", "\1QAbstractItemModel.columnsAboutToBeInserted(QModelIndex, int, int)", 0},
    {"rowsRemoved(const QModelIndex&,int,int)", "\1QAbstractItemModel.rowsRemoved(QModelIndex, int, int)", 0},
    {"rowsAboutToBeRemoved(const QModelIndex&,int,int)", "\1QAbstractItemModel.rowsAboutToBeRemoved(QModelIndex, int, int)", 0},
    {"rowsInserted(const QModelIndex&,int,int)", "\1QAbstractItemModel.rowsInserted(QModelIndex, int, int)", 0},
    {"rowsAboutToBeInserted(const QModelIndex&,int,int)", "\1QAbstractItemModel.rowsAboutToBeInserted(QModelIndex, int, int)", 0},
    {"layoutChanged()", "\1QAbstractItemModel.layoutChanged()", 0},
    {"layoutAboutToBeChanged()", "\1QAbstractItemModel.layoutAboutToBeChanged()", 0},
    {"headerDataChanged(Qt::Orientation,int,int)", "\1QAbstractItemModel.headerDataChanged(Qt.Orientation, int, int)", 0},
    {"dataChanged(const QModelIndex&,const QModelIndex&)", "\1QAbstractItemModel.dataChanged(QModelIndex, QModelIndex)", 0},
    {0, 0, 0}
};
