...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtCore/qsettings.sip"
#include <qsettings.h>
...
PyDoc_STRVAR(doc_QSettings_value, "QSettings.value(QString, QVariant defaultValue=QVariant()) -> QVariant");
...
static PyObject *meth_QSettings_setIniCodec(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QSettings, &sipCpp, sipType_QTextCodec, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QSettings[] = {{129, 255, 1}};
...
static sipEnumMemberDef enummembers_QSettings[] = {
    {sipName_AccessError, QSettings::AccessError, 162},
    {sipName_FormatError, QSettings::FormatError, 162},
    {sipName_IniFormat, QSettings::IniFormat, 160},
    {sipName_InvalidFormat, QSettings::InvalidFormat, 160},
    {sipName_NativeFormat, QSettings::NativeFormat, 160},
    {sipName_NoError, QSettings::NoError, 162},
    {sipName_SystemScope, QSettings::SystemScope, 161},
    {sipName_UserScope, QSettings::UserScope, 161},
};
