...
static PyObject *meth_QFile_readData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "pn", &sipSelf, sipType_QFile, &sipCpp, &a0))
        {
            PyObject * sipRes = 0;
            int sipIsErr = 0;

#line 147 "/home/maemo/python-qt4-4.7/sip/QtCore/qfile.sip"
...
#line 185 "/home/maemo/python-qt4-4.7/sip/QtCore/qfile.sip"
        // Return the data read or None if there was an error.
        if (a0 < 0)
        {
            PyErr_SetString(PyExc_ValueError, "maximum length of data to be read cannot be negative");
...
static PyMethodDef methods_QFile[] = {
    ...
    {SIP_MLNAME_CAST(sipName_readData), (PyCFunction)meth_QFile_readData, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QFile_readData)},
    {SIP_MLNAME_CAST(sipName_readLineData), (PyCFunction)meth_QFile_readLineData, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QFile_readLineData)},
...
static sipEnumMemberDef enummembers_QFile[] = {
    {sipName_AbortError, QFile::AbortError, 64},
    {sipName_CopyError, QFile::CopyError, 64},
    {sipName_ExeGroup, QFile::ExeGroup, 66},
    {sipName_ExeOther, QFile::ExeOther, 66},
    {sipName_ExeOwner, QFile::ExeOwner, 66},
    {sipName_ExeUser, QFile::ExeUser, 66},
    {sipName_FatalError, QFile::FatalError, 64},
    {sipName_NoError, QFile::NoError, 64},
    {sipName_NoOptions, QFile::NoOptions, 65},
    {sipName_OpenError, QFile::OpenError, 64},
    {sipName_PermissionsError, QFile::PermissionsError, 64},
    {sipName_PositionError, QFile::PositionError, 64},
    {sipName_ReadError, QFile::ReadError, 64},
    {sipName_ReadGroup, QFile::ReadGroup, 66},
    {sipName_ReadOther, QFile::ReadOther, 66},
    {sipName_ReadOwner, QFile::ReadOwner, 66},
    {sipName_ReadUser, QFile::ReadUser, 66},
    {sipName_RemoveError, QFile::RemoveError, 64},
    {sipName_RenameError, QFile::RenameError, 64},
    {sipName_ResizeError, QFile::ResizeError, 64},
    {sipName_ResourceError, QFile::ResourceError, 64},
    {sipName_TimeOutError, QFile::TimeOutError, 64},
    {sipName_UnspecifiedError, QFile::UnspecifiedError, 64},
    {sipName_WriteError, QFile::WriteError, 64},
    {sipName_WriteGroup, QFile::WriteGroup, 66},
    {sipName_WriteOther, QFile::WriteOther, 66},
    {sipName_WriteOwner, QFile::WriteOwner, 66},
    {sipName_WriteUser, QFile::WriteUser, 66},
};
