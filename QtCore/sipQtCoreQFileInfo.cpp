...
PyDoc_STRVAR(doc_QFileInfo_detach, "QFileInfo.detach()");
...
static PyObject *meth_QFileInfo_detach(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QFileInfo, sipName_detach, doc_QFileInfo_detach);
...
static PyMethodDef methods_QFileInfo[] = {
    ...
    {SIP_MLNAME_CAST(sipName_detach), meth_QFileInfo_detach, METH_VARARGS, SIP_MLDOC_CAST(doc_QFileInfo_detach)},
