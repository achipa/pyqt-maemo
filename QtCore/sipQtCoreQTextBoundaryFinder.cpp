...
static sipEnumMemberDef enummembers_QTextBoundaryFinder[] = {
    {sipName_EndWord, QTextBoundaryFinder::EndWord, 198},
    {sipName_Grapheme, QTextBoundaryFinder::Grapheme, 200},
    {sipName_Line, QTextBoundaryFinder::Line, 200},
    {sipName_NotAtBoundary, QTextBoundaryFinder::NotAtBoundary, 198},
    {sipName_Sentence, QTextBoundaryFinder::Sentence, 200},
    {sipName_StartWord, QTextBoundaryFinder::StartWord, 198},
    {sipName_Word, QTextBoundaryFinder::Word, 200},
};
