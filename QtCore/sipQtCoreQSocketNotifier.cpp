...
static sipEncodedTypeDef supers_QSocketNotifier[] = {{129, 255, 1}};
...
static sipEnumMemberDef enummembers_QSocketNotifier[] = {
    {sipName_Exception, QSocketNotifier::Exception, 171},
    {sipName_Read, QSocketNotifier::Read, 171},
    {sipName_Write, QSocketNotifier::Write, 171},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QSocketNotifier[] = {
    {"activated(int)", "\1QSocketNotifier.activated(int)", 0},
    {0, 0, 0}
};
