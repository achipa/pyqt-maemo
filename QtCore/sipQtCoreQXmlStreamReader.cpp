...
static PyObject *meth_QXmlStreamReader_setEntityResolver(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlStreamReader, &sipCpp, sipType_QXmlStreamEntityResolver, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
static sipEnumMemberDef enummembers_QXmlStreamReader[] = {
    {sipName_Characters, QXmlStreamReader::Characters, 253},
    {sipName_Comment, QXmlStreamReader::Comment, 253},
    {sipName_CustomError, QXmlStreamReader::CustomError, 251},
    {sipName_DTD, QXmlStreamReader::DTD, 253},
    {sipName_EndDocument, QXmlStreamReader::EndDocument, 253},
    {sipName_EndElement, QXmlStreamReader::EndElement, 253},
    {sipName_EntityReference, QXmlStreamReader::EntityReference, 253},
    {sipName_ErrorOnUnexpectedElement, QXmlStreamReader::ErrorOnUnexpectedElement, 252},
    {sipName_IncludeChildElements, QXmlStreamReader::IncludeChildElements, 252},
    {sipName_Invalid, QXmlStreamReader::Invalid, 253},
    {sipName_NoError, QXmlStreamReader::NoError, 251},
    {sipName_NoToken, QXmlStreamReader::NoToken, 253},
    {sipName_NotWellFormedError, QXmlStreamReader::NotWellFormedError, 251},
    {sipName_PrematureEndOfDocumentError, QXmlStreamReader::PrematureEndOfDocumentError, 251},
    {sipName_ProcessingInstruction, QXmlStreamReader::ProcessingInstruction, 253},
    {sipName_SkipChildElements, QXmlStreamReader::SkipChildElements, 252},
    {sipName_StartDocument, QXmlStreamReader::StartDocument, 253},
    {sipName_StartElement, QXmlStreamReader::StartElement, 253},
    {sipName_UnexpectedElementError, QXmlStreamReader::UnexpectedElementError, 251},
};
