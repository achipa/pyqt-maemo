...
#line 138 "/home/maemo/python-qt4-4.7/sip/QtCore/qset.sip"
#include <qset.h>
...
static void dealloc_QStateMachine(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQStateMachine *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QStateMachine(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static sipEncodedTypeDef supers_QStateMachine[] = {{172, 255, 1}};
...
static sipEnumMemberDef enummembers_QStateMachine[] = {
    {sipName_DontRestoreProperties, QStateMachine::DontRestoreProperties, 177},
    {sipName_HighPriority, QStateMachine::HighPriority, 176},
    {sipName_NoCommonAncestorForTransitionError, QStateMachine::NoCommonAncestorForTransitionError, 175},
    {sipName_NoDefaultStateInHistoryStateError, QStateMachine::NoDefaultStateInHistoryStateError, 175},
    {sipName_NoError, QStateMachine::NoError, 175},
    {sipName_NoInitialStateError, QStateMachine::NoInitialStateError, 175},
    {sipName_NormalPriority, QStateMachine::NormalPriority, 176},
    {sipName_RestoreProperties, QStateMachine::RestoreProperties, 177},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QStateMachine[] = {
    {"stopped()", "\1QStateMachine.stopped()", 0},
    {"started()", "\1QStateMachine.started()", 0},
    {0, 0, 0}
};
