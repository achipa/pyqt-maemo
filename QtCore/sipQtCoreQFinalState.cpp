...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtCore/qfinalstate.sip"
...
static void dealloc_QFinalState(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQFinalState *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QFinalState(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
