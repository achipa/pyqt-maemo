...
static PyObject *meth_QState_setErrorState(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QState, &sipCpp, sipType_QAbstractState, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
...
#line 58 "/home/maemo/python-qt4-4.7/sip/QtCore/qstate.sip"
        QObject *sender;
        const char *signal;
...
static void dealloc_QState(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQState *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QState(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static PyMethodDef methods_QState[] = {
    {SIP_MLNAME_CAST(sipName_addTransition), (PyCFunction)meth_QState_addTransition, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_QState_addTransition)},
...
static sipEnumMemberDef enummembers_QState[] = {
    {sipName_ExclusiveStates, QState::ExclusiveStates, 173},
    {sipName_ParallelStates, QState::ParallelStates, 173},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QState[] = {
    {"propertiesAssigned()", "\1QState.propertiesAssigned()", 0},
    {"finished()", "\1QState.finished()", 0},
    {0, 0, 0}
};
