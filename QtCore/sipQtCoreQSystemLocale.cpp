...
static sipEnumMemberDef enummembers_QSystemLocale[] = {
    {sipName_AMText, QSystemLocale::AMText, 192},
    {sipName_CountryId, QSystemLocale::CountryId, 192},
    {sipName_DateFormatLong, QSystemLocale::DateFormatLong, 192},
    {sipName_DateFormatShort, QSystemLocale::DateFormatShort, 192},
    {sipName_DateTimeFormatLong, QSystemLocale::DateTimeFormatLong, 192},
    {sipName_DateTimeFormatShort, QSystemLocale::DateTimeFormatShort, 192},
    {sipName_DateTimeToStringLong, QSystemLocale::DateTimeToStringLong, 192},
    {sipName_DateTimeToStringShort, QSystemLocale::DateTimeToStringShort, 192},
    {sipName_DateToStringLong, QSystemLocale::DateToStringLong, 192},
    {sipName_DateToStringShort, QSystemLocale::DateToStringShort, 192},
    {sipName_DayNameLong, QSystemLocale::DayNameLong, 192},
    {sipName_DayNameShort, QSystemLocale::DayNameShort, 192},
    {sipName_DecimalPoint, QSystemLocale::DecimalPoint, 192},
    {sipName_GroupSeparator, QSystemLocale::GroupSeparator, 192},
    {sipName_LanguageId, QSystemLocale::LanguageId, 192},
    {sipName_MeasurementSystem, QSystemLocale::MeasurementSystem, 192},
    {sipName_MonthNameLong, QSystemLocale::MonthNameLong, 192},
    {sipName_MonthNameShort, QSystemLocale::MonthNameShort, 192},
    {sipName_NegativeSign, QSystemLocale::NegativeSign, 192},
    {sipName_PMText, QSystemLocale::PMText, 192},
    {sipName_PositiveSign, QSystemLocale::PositiveSign, 192},
    {sipName_TimeFormatLong, QSystemLocale::TimeFormatLong, 192},
    {sipName_TimeFormatShort, QSystemLocale::TimeFormatShort, 192},
    {sipName_TimeToStringLong, QSystemLocale::TimeToStringLong, 192},
    {sipName_TimeToStringShort, QSystemLocale::TimeToStringShort, 192},
    {sipName_ZeroDigit, QSystemLocale::ZeroDigit, 192},
};
