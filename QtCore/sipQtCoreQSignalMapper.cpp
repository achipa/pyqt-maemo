...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtCore/qsignalmapper.sip"
...
static sipEncodedTypeDef supers_QSignalMapper[] = {{129, 255, 1}};
...
static const pyqt4QtSignal pyqt4_signals_QSignalMapper[] = {
    {"mapped(int)", "\1QSignalMapper.mapped(int)", 0},
    {"mapped(const QString&)", "\1QSignalMapper.mapped(QString)", 0},
    {"mapped(QWidget *)", "\1QSignalMapper.mapped(QWidget)", 0},
    {"mapped(QObject *)", "\1QSignalMapper.mapped(QObject)", 0},
    {0, 0, 0}
};
