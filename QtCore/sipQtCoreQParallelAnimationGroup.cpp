...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtCore/qparallelanimationgroup.sip"
...
static void dealloc_QParallelAnimationGroup(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQParallelAnimationGroup *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QParallelAnimationGroup(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
