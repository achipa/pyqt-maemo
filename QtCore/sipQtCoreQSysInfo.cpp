...
static sipEnumMemberDef enummembers_QSysInfo[] = {
    {sipName_BigEndian, QSysInfo::BigEndian, 189},
    {sipName_ByteOrder, QSysInfo::ByteOrder, 189},
    {sipName_LittleEndian, QSysInfo::LittleEndian, 189},
    {sipName_WordSize, QSysInfo::WordSize, 190},
};
