...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtCore/qsequentialanimationgroup.sip"
...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtCore/qpauseanimation.sip"
...
static void dealloc_QSequentialAnimationGroup(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerived(sipSelf))
        reinterpret_cast<sipQSequentialAnimationGroup *>(sipSelf->u.cppPtr)->sipPySelf = NULL;

    if (sipIsPyOwned(sipSelf))
    {
        release_QSequentialAnimationGroup(sipSelf->u.cppPtr,sipSelf->flags);
    }
}
...
static const pyqt4QtSignal pyqt4_signals_QSequentialAnimationGroup[] = {
    {"currentAnimationChanged(QAbstractAnimation *)", "\1QSequentialAnimationGroup.currentAnimationChanged(QAbstractAnimation)", 0},
    {0, 0, 0}
};
