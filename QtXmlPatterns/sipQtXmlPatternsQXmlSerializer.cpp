...
#line 39 "/home/maemo/python-qt4-4.7/sip/QtXmlPatterns/qxmlserializer.sip"
...
static PyObject *meth_QXmlSerializer_setCodec(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QXmlSerializer, &sipCpp, sipType_QTextCodec, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->setCodec(a0);
            Py_END_ALLOW_THREADS
