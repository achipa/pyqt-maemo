...
#line 37 "/home/maemo/python-qt4-4.7/sip/QtOpenGL/qglpixelbuffer.sip"
...
static PyObject *meth_QGLPixelBuffer_bindToDynamicTexture(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "Bm", &sipSelf, sipType_QGLPixelBuffer, &sipCpp, &a0))
        {
            bool sipRes;
...
static PyObject *meth_QGLPixelBuffer_bindTexture(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|m", &sipSelf, sipType_QGLPixelBuffer, &sipCpp, sipType_QImage, &a0, &a1))
        {
            GLuint sipRes;
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9|m", &sipSelf, sipType_QGLPixelBuffer, &sipCpp, sipType_QPixmap, &a0, &a1))
        {
            GLuint sipRes;
...
static PyObject *meth_QGLPixelBuffer_drawTexture(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9m|m", &sipSelf, sipType_QGLPixelBuffer, &sipCpp, sipType_QRectF, &a0, &a1, &a2))
        {
            Py_BEGIN_ALLOW_THREADS
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9m|m", &sipSelf, sipType_QGLPixelBuffer, &sipCpp, sipType_QPointF, &a0, &a1, &a2))
        {
            Py_BEGIN_ALLOW_THREADS
            sipCpp->drawTexture(*a0,a1,a2);
            Py_END_ALLOW_THREADS
...
static sipEncodedTypeDef supers_QGLPixelBuffer[] = {{357, 1, 1}};
